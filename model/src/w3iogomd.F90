...
1008 FORMAT (/' *** WAVEWATCH III WARNING  : '/                       &
  ...
  SUBROUTINE W3OUTG ( A, FLPART, FLOUTG, FLOUTG2 )
    ...
    USE W3ADATMD , ONLY : THM, THS, THP0
    USE W3ADATMD , ONLY : ABA, ABD, UBA, UBD, FCUT, SXX
    USE W3ADATMD , ONLY : SYY, SXY, PHS, PTP, PLP, PDIR, PSI, PWS
    USE W3ADATMD , ONLY : PWST, PNR, USERO, TUSX, TUSY, PRMS, TPMS
    USE W3ADATMD , ONLY : USSX, USSY, MSSX, MSSY, MSSD, MSCX, MSCY
    USE W3ADATMD , ONLY : MSCD, CHARN
    USE W3ADATMD , ONLY : BHD, CGE, P2SMS, US3D, EF, TH1M, STH1M
    USE W3ADATMD , ONLY : TH2M, STH2M, HSIG, STMAXE, STMAXD
    USE W3ADATMD , ONLY : HCMAXE, HMAXE, HCMAXD, HMAXD, USSP, QP, PQP
    USE W3ADATMD , ONLY : PTHP0, PPE, PGW, PSW, PTM1, PT1, PT2, PEP
    USE W3ADATMD , ONLY : WBT
    USE W3ODATMD , ONLY : NDST, UNDEF, IAPROC, NAPROC, NAPFLD
    USE W3ODATMD , ONLY : ICPRT, DTPRT, WSCUT, NOSWLL, FLOGRD, FLOGR2
    USE W3ODATMD , ONLY : NOGRP, NGRPP
    ...
    USE W3ADATMD , ONLY : LAMULT, USSXH, USSYH, LANGMT, LAPROJ, ALPHAL, ALPHALS
    USE W3ADATMD , ONLY : LASL, UD, LASLPJ
...
9054 FORMAT (2X,I8,2I8,F6.2,F7.1,F6.2,2F6.1,F6.3,F6.0)
  ...
  SUBROUTINE W3IOGO ( INXOUT, NDSOG, IOTST, IMOD )
    ...
    USE W3WDATMD , ONLY : UST,  USTDIR, ASF, RHOAIR
    ...
    USE W3ADATMD , ONLY : USSP, TAUOCX, TAUOCY
    !/
    USE W3ODATMD , ONLY : NOGRP, NGRPP, IDOUT, UNDEF, NDST, NDSE
    USE W3ODATMD , ONLY : FLOGRD, IPASS => IPASS1, WRITE => WRITE1
    USE W3ODATMD , ONLY : FNMPRE, NOSWLL, NOEXTR
    !/
...
9020 FORMAT (' TEST W3IOGO : END OF FILE REACHED')
  ...
  SUBROUTINE CALC_U3STOKES ( A , USS_SWITCH )
    ...
    USE W3GDATMD  , ONLY : ECOS, ESIN, US3DF, USSPF, USSP_WN
    USE W3ADATMD  , ONLY : CG, WN, DW
  ...
  SUBROUTINE CALC_WBT (A)
    ...
    USE W3GDATMD , ONLY : FTE, XFR, MAPSF, MAPSTA, DMIN
