...
CONTAINS
  ...
  SUBROUTINE W3XYPUG ( ISP, FACX, FACY, DTG, VQ, VGX, VGY, LCALC )
    ...
    USE W3GDATMD , ONLY : ECOS, ESIN, SIG,  PFMOVE,IEN
    USE W3GDATMD , ONLY : NTRI, TRIGP, CCON
    USE W3GDATMD , ONLY : IE_CELL, POS_CELL, IOBP, IOBPD, IOBDP
    USE W3GDATMD , ONLY : FSN, FSPSI, FSFCT, FSNIMP, GTYPE, UNGTYPE
  ...
  SUBROUTINE W3CFLUG ( ISEA, NKCFL, FACX, FACY, DT, MAPFS, CFLXYMAX,    &
    ...
    USE W3GDATMD , ONLY : FLCX, FLCY, NK, NTH, DTH, XFR
    USE W3GDATMD , ONLY : ECOS, ESIN, SIG,  PFMOVE,IEN, INDEX_CELL
    USE W3GDATMD , ONLY : NTRI, TRIGP, CCON
    USE W3GDATMD , ONLY : IE_CELL, POS_CELL, COUNTRI, SI, IOBP
  ...
  SUBROUTINE W3XYPFSN2 ( ISP, C, LCALC, RD10, RD20, DT, AC)
    ...
    USE W3GDATMD, ONLY : IEN, TRIGP, CLATS, MAPSF, IOBPD, IOBP, IOBDP
USE W3GDATMD, ONLY : IOBPA, FSBCCFL
#ifdef W3_REF1
    ...
    REAL,             INTENT(IN)    :: DT         ! Time intervall for which the advection should be
                                                  ! computed for the given velocity field
  ...
  SUBROUTINE W3XYPFSPSI2 ( ISP, C, LCALC, RD10, RD20, DT, AC)
    ...
    !/
    USE W3GDATMD, ONLY : NK, NTH, NTRI, NX, CCON, IE_CELL,POS_CELL, SI
    USE W3GDATMD, ONLY : IEN, TRIGP, CLATS, MAPSF, IOBPA, IOBPD, IOBP, NNZ, IOBDP
#ifdef W3_REF1
    USE W3GDATMD, ONLY :  REFPARS
#endif
    USE W3WDATMD , ONLY : TIME
  ...
  SUBROUTINE W3XYPFSNIMP ( ISP, C, LCALC, RD10, RD20, DT, AC)
    ...
    !/
    USE W3GDATMD, ONLY : NK, NTH, NTRI, NX, CCON, IE_CELL,POS_CELL, SI
    USE W3GDATMD, ONLY : IEN, TRIGP, CLATS, MAPSF, IOBPD, IOBPA, IOBP, IAA, JAA, POSI
    USE W3GDATMD, ONLY : TRIA, NNZ
#ifdef W3_REF1
    USE W3GDATMD, ONLY : REFPARS
#endif
    USE W3WDATMD , ONLY : TIME
  ...
  SUBROUTINE W3XYPFSFCT2 ( ISP, C, LCALC, RD10, RD20, DT, AC)
    ...
    !/
    USE W3GDATMD, ONLY : NK, NTH, NTRI, NX, CCON, IE_CELL,POS_CELL, SI
    USE W3GDATMD, ONLY : IEN, TRIGP, CLATS, MAPSF, IOBPD, IOBPA, TRIA, IOBDP
#ifdef W3_REF1
    USE W3GDATMD, ONLY : REFPARS
#endif
    USE W3WDATMD , ONLY : TIME
