...
PROGRAM W3OUTF
  ...
  USE W3WDATMD , ONLY : USTDIR, RHOAIR
  ...
  USE W3ADATMD , ONLY : TAUOX, TAUOY, TAUWIX,BHD
  USE W3ADATMD , ONLY : TAUWIY, PHIAW, PHIOC, TUSX, TUSY, PRMS, TPMS
  USE W3ADATMD , ONLY : USSX, USSY, MSSX, MSSY, MSCX, MSCY, CHARN
  USE W3ADATMD , ONLY : TAUWNX, TAUWNY, TAUBBL, PHIBBL, CFLXYMAX
  USE W3ADATMD , ONLY : CFLTHMAX, CFLKMAX, BEDFORMS, WHITECAP, T02
  USE W3ADATMD , ONLY : CGE, T01, HSIG, STMAXE, STMAXD, HMAXE
  USE W3ADATMD , ONLY : HCMAXE, HMAXD, HCMAXD, MSSD, MSCD, WBT
  USE W3ADATMD , ONLY : WNMEAN, TAUA, TAUADIR
