...
MODULE W3IDATMD
  ...
  INTEGER           :: JFIRST = 1
  INTEGER           :: NTIDE   ! number of tidal constituents ! W3_TIDE
...
1001 FORMAT (/' *** ERROR W3NINP : NGRIDS NOT YET SET *** '/         &
         ...
         '                    RUN W3NMOD FIRST'/)
    !
9000 FORMAT (' TEST W3NINP : SETTING UP FOR ',I2,' -',I3,' GRIDS') ! W3_T
    !/
    !/ End of W3NINP ----------------------------------------------------- /
    !/
  ...
  SUBROUTINE W3DIMI  ( IMOD, NDSE, NDST, FLAGSTIDEIN )
    ...
    !
    FLLEVTIDE  => INPUTS(IMOD)%INFLAGS1(11) ! W3_TIDE
    FLCURTIDE  => INPUTS(IMOD)%INFLAGS1(12) ! W3_TIDE
    FLLEVRESI  => INPUTS(IMOD)%INFLAGS1(13) ! W3_TIDE
    FLCURRESI  => INPUTS(IMOD)%INFLAGS1(14) ! W3_TIDE
    !
    FLLEVTIDE = FLAGSTIDE(1) ! W3_TIDE
    FLCURTIDE = FLAGSTIDE(2) ! W3_TIDE
    FLLEVRESI = FLAGSTIDE(3) ! W3_TIDE
    FLCURRESI = FLAGSTIDE(4) ! W3_TIDE
...
1003 FORMAT (/' *** ERROR W3DIMI : ARRAY(S) ALREADY ALLOCATED *** ')
    !
9000 FORMAT (' TEST W3DIMI : MODEL ',I4,' DIM. AT ',2I5,I7) ! W3_T
...
1002 FORMAT (/' *** ERROR W3SETI : ILLEGAL MODEL NUMBER *** '/       &
         ...
         '                    NIDATA = ',I10/)
    !
9000 FORMAT (' TEST W3SETI : MODEL ',I4,' SELECTED') ! W3_T
    !/
    !/ End of W3SETI ----------------------------------------------------- /
    !/
