...
CONTAINS
  ...
  SUBROUTINE PRINT_MY_TIME(string)
    ...
    if (w3_s_flag) then
       CALL STRACE (IENT, 'PRINT_MY_TIME') ! W3_S
    end if
  ...
  SUBROUTINE SYNCHRONIZE_IPGL_ETC_ARRAY(IMOD, IsMulti)
    ...
    !/ ------------------------------------------------------------------- /
    USE W3SERVMD      , ONLY: STRACE                       ! W3_S
    USE W3ODATMD      , ONLY: NTPROC, NAPROC, IAPROC       ! W3_PDLIB
    USE W3GDATMD      , ONLY: MAPSF, NSEA                  ! W3_PDLIB
    USE W3ADATMD      , ONLY: MPI_COMM_WAVE, MPI_COMM_WCMP ! W3_PDLIB
#ifdef W3_PDLIB
    ...
    !/ Local parameters
    !/
    INTEGER       :: Iarr(1) ! W3_PDLIB
    INTEGER       :: ISEA, IP_glob ! W3_PDLIB
    INTEGER       :: IPROC, IERR_MPI, istat ! W3_PDLIB
    INTEGER, SAVE :: IENT = 0 ! W3_S
    !/
    !/ ------------------------------------------------------------------- /
