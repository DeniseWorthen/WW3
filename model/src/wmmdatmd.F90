...
MODULE WMMDATMD
  ...
  INTEGER              :: MDSP              !< MDSP ! W3_MPRF
  INTEGER              :: MPI_COMM_MWAVE    !< MPI_COMM_MWAVE ! W3_MPI
  ...
  INTEGER, ALLOCATABLE :: NBISTA(:)         !< NBISTA ! W3_MPI
  ...
  TYPE MDATA
     ...
     INTEGER          :: MPI_COMM_GRD        !< MPI_COMM_GRD ! W3_MPI
     ...
     INTEGER, POINTER :: IRQBPG(:)           !< IRQBPG ! W3_MPI
  ...
  TYPE HGST
     ...
     INTEGER, POINTER :: IRQHGS(:)   !< IRQHGS ! W3_MPI
  ...
  TYPE EQST
     ...
     INTEGER, POINTER :: IRQEQS(:)   !< IRQEQS ! W3_MPI
     INTEGER, POINTER :: OUTDAT(:,:) !< OUTDAT
  ...
  INTEGER, POINTER :: MAPMSK(:,:)         !< MAPMSK
  INTEGER, POINTER :: UPTMAP(:)           !< UPTMAP
  INTEGER, POINTER :: MPI_COMM_GRD        !< MPI_COMM_GRD ! W3_MPI
...
1003 FORMAT (/' *** ERROR WMDIMD : ARRAY(S) ALREADY ALLOCATED *** ')
    !
9000 FORMAT (' TEST WMDIMD : MODEL ',I4,' DIM. AT ',2I5,I7) ! W3_T
...
1003 FORMAT (/' *** ERROR WMDIMM : ARRAY(S) ALREADY ALLOCATED *** ')
    !
9000 FORMAT (' TEST WMDIMM : MODEL ',I4,' DIM. AT ',2I5,I7) ! W3_T
...
1002 FORMAT (/' *** ERROR WMSETM : ILLEGAL MODEL NUMBER *** '/       &
         ...
         '                    NMDATA = ',I10/)
    !
9000 FORMAT (' TEST WMSETM : MODEL ',I4,' SELECTED') ! W3_T
    !/
    !/ End of WMSETM ----------------------------------------------------- /
    !/
