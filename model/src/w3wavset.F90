MODULE W3WAVSET
  ...
  !/ ------------------------------------------------------------------- /
  !
#if defined(W3_PDLIB) && defined(W3_MPI) 
  !
  use wav_shr_flags
  !
  USE W3SERVMD, ONLY: STRACE ! W3_S
  !
  ! PROBLEM (MV) callable statements were at the module level rather than in a subroutine
  ! These were all prefaced by W3_S ifdefs and  have been removed 
  implicit none
...
CONTAINS
  ...
  SUBROUTINE DIFFERENTIATE_XYDIR_NATIVE(VAR, DVDX, DVDY)
    ...
    !/ ------------------------------------------------------------------- /
    !/ Parameter list
    ! PROBLEM (MV) this appeared below the callable statements 
    !/
  ...
  SUBROUTINE FD_WAVE_SETUP_COMPUTATION
    ...
    !/ Local PARAMETERs
    !/
    ! PROBLEM (MV) these appeared below callable statements (call strace)
    INTEGER :: IENT = 0 ! W3_S
  ...
  SUBROUTINE WAVE_SETUP_COMPUTATION
    ...
    !/ Local PARAMETERs
    !/
    ! PROBLEM (MV) - these appeared below callable statemetns
    INTEGER             :: IENT = 0 ! W3_S
    INTEGER             :: ISEA, JSEA
