...
MODULE W3NMLSHELMD
  ...
  !
  TYPE NML_COUPLING_T 
     CHARACTER(1024)         :: SENT     ! W3_COU
     CHARACTER(1024)         :: RECEIVED ! W3_COU
     LOGICAL                 :: COUPLET0 ! W3_COU
  ...
  TYPE NML_OUTPUT_TYPE_T
     ...
     TYPE(NML_COUPLING_T)    :: COUPLING ! W3_COU
...
CONTAINS
  ...
  SUBROUTINE READ_OUTPUT_TYPE_NML (NDSI, NML_OUTPUT_TYPE)
    ...
    TYPE%COUPLING%SENT      = 'unset' ! W3_COU
    TYPE%COUPLING%RECEIVED  = 'unset' ! W3_COU 
    TYPE%COUPLING%COUPLET0  = .FALSE. ! W3_COU
