...
contains
  ...
  subroutine set_shel_io(stdout,mds,ntrace)
    ...
    ! call ESMF_UtilIOUnitGet(mds(14)); open(unit=mds(14) , status='scratch')
    ! call ESMF_UtilIOUnitGet(mds(15)); open(unit=mds(15) , status='scratch')
    ! close(mds(5)); close(mds(6)); close(mds(7)); close(mds(8)); close(mds(9)); close(mds(10))
    ! close(mds(11)); close(mds(12)); close(mds(13)); close(mds(14)); close(mds(15))
