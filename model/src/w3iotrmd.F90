...
CONTAINS
  ...
  SUBROUTINE W3IOTR ( NDSINP, NDSOUT, A, IMOD )
    ...
    USE W3GDATMD , ONLY  FLAGLL, ICLOSE, XGRD, YGRD, GSU
    USE W3GDATMD , ONLY  DPDX, DPDY, DQDX, DQDY, MAPSTA, MAPST2
    USE W3GDATMD , ONLY  MAPFS, TH, DTH, SIG, DSIP, XFR, FILEXT
    ...
    USE W3ODATMD , ONLY  IPASS => IPASS3, ATOLAST => TOLAST
    USE W3ODATMD , ONLY  ADTOUT => DTOUT, O3INIT, STOP, MASK1
    USE W3ODATMD , ONLY  MASK2, TRCKID, FNMPRE
#ifdef W3_MPI
