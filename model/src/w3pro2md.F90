...
CONTAINS
  ...
  SUBROUTINE W3MAP2
    ...
    ! Formats
    !
9000 FORMAT (/' TEST W3MAP2 : TEST MAP FOR PROPAGATION'/          & ! W3_T
         '      MAP     : ',A/                               &
         '      CENTRAL : ',I6/                              &
         '      ABOVE   : ',I6/                              &
         '      BELOW   : ',I6/                              &
...
9001 FORMAT (1X,130I1)
    !
9010 FORMAT (' TEST W3MAP2 : COMPOSITE MAPS TH2, WN2 AND BTK') ! W3_T
9011 FORMAT (2X,60I2)
    !/
    !/ End of W3MAP2 ----------------------------------------------------- /
    !/
  ...
  SUBROUTINE W3XYP2 ( ISP, DTG, MAPSTA, MAPFS, VQ, VGX, VGY )
    ...
    !/ Local parameters
    !/
    INTEGER :: ITH, IK, NTLOC, ITLOC, ISEA, IXY, IX,IY, IY0, IP, IBI
    INTEGER :: TTEST(2),DTTST
    INTEGER :: IENT = 0 ! W3_S
    REAL    :: CG0, CGA, CGN, CGX, CGY, CXC, CYC, CXMIN, CXMAX, CYMIN, CYMAX
    REAL    :: DTLOC, DTRAD, DFRR, CELLP,  CGD, DSSD, DNND, DCELL, XWIND, TFAC, DSS, DNN
    REAL    :: RD1, RD2
    ...
    ! Formats
    !
9000 FORMAT (' TEST W3XYP2 : YFIRST  :',L2) ! W3_T
...
9003 FORMAT (' TEST W3XYP2 : NO DISPERSION CORRECTION ')
    !
9010 FORMAT (' TEST W3XYP2 : INITIALIZE ARRAYS') ! W3_T
    !
9020 FORMAT (' TEST W3XYP2 : CALCULATING LCFLX/Y AND DSS/NN (NSEA=', & ! W3_T
         I6,')')
9021 FORMAT (1X,I6,2I5,E12.4,2f7.3) ! W3_T1
9022 FORMAT (' TEST W3XYP2 : CORRECTING FOR CURRENT') ! W3_T
    !
9040 FORMAT (' TEST W3XYP2 : FIELD AFTER PROP. (NSEA=',I6,')') ! W3_T
9041 FORMAT (1X,I6,2I5,E12.4)
  ...
  SUBROUTINE W3KTP2 ( ISEA, FACTH, FACK, CTHG0, CG, WN, DEPTH,    &
    ...
    ! Formats
    !
9000 FORMAT ( ' TEST W3KTP2 : FLCTH-K, FACTH-K, CTMAX  :',        & ! W3_T
         2L2,2E10.3,F7.3)
