...
MODULE W3ADATMD
  ...
  INTEGER, PARAMETER      :: MPIBUF = 6 ! W3_MPI
  !/
  ...
  TYPE WADAT
     ...
     !
     REAL, POINTER :: CG(:,:), WN(:,:)
     REAL, POINTER :: IC3WN_R(:,:), IC3WN_I(:,:), IC3CG(:,:) ! W3_IC3
     !
     ...
     REAL, POINTER :: XLANGMT(:) ! W3_CESMCOUPLED
     !
     ...
     REAL, POINTER    :: DHDX(:), DHDY(:), DHLMT(:,:) ! W3_SMC
     !
     INTEGER, POINTER :: IS0(:), IS2(:)     ! W3_PR1
     REAL, POINTER    :: FACVX(:), FACVY(:) ! W3_PR1
     !
     INTEGER          :: NMX0, NMX1, NMX2, NMY0, NMY1, NMY2, NACT            ! W3_PR2, W3_PR3
     INTEGER, POINTER :: MAPX2(:), MAPY2(:), MAPAXY(:), MAPTH2(:), MAPWN2(:) ! W3_PR2, W3_PR3
     INTEGER, POINTER :: MAPXY(:)                                            ! W3_PR2 
     INTEGER          :: NMXY                                                ! W3_PR2
     INTEGER, POINTER :: MAPCXY(:)                                           ! W3_PR3 
     INTEGER          :: NCENT                                               ! W3_PR3
     LOGICAL, POINTER :: MAPTRN(:)                                           ! W3_PR3
     !
     ! Warning Defined but not set if UGTYPE .EQ. .T.
     INTEGER, POINTER :: ITER(:,:)
     !
     INTEGER          :: NFR, NFRHGH, NFRCHG, NSPECX, NSPECY ! W3_NL1
     INTEGER, POINTER :: IP11(:), IP12(:), IP13(:), IP14(:)  ! W3_NL1
     INTEGER, POINTER :: IM11(:), IM12(:), IM13(:), IM14(:)  ! W3_NL1
     INTEGER, POINTER :: IP21(:), IP22(:), IP23(:), IP24(:)  ! W3_NL1
     INTEGER, POINTER :: IM21(:), IM22(:), IM23(:), IM24(:)  ! W3_NL1
     INTEGER, POINTER :: IC11(:), IC12(:), IC21(:), IC22(:)  ! W3_NL1
     INTEGER, POINTER :: IC31(:), IC32(:), IC41(:), IC42(:)  ! W3_NL1
     INTEGER, POINTER :: IC51(:), IC52(:), IC61(:), IC62(:)  ! W3_NL1
     INTEGER, POINTER :: IC71(:), IC72(:), IC81(:), IC82(:)  ! W3_NL1
     REAL             :: DAL1, DAL2, DAL3                    ! W3_NL1
     REAL             :: AWG1, AWG2, AWG3, AWG4, AWG5, AWG6  ! W3_NL1
     REAL             :: AWG7, AWG8, SWG1, SWG2, SWG3, SWG4  ! W3_NL1
     REAL             :: SWG5, SWG6, SWG7, SWG8              ! W3_NL1
     REAL, POINTER    :: AF11(:)                             ! W3_NL1
     LOGICAL          :: NLINIT                              ! W3_NL1
     !
     INTEGER, POINTER :: IAPPRO(:)
     INTEGER          :: MPI_COMM_WAVE, MPI_COMM_WCMP       ! W3_MPI
     INTEGER          :: WW3_FIELD_VEC, WW3_SPEC_VEC        ! W3_MPI
     INTEGER          :: NRQSG1 = 0, NRQSG2, IBFLOC, ISPLOC ! W3_MPI
     INTEGER          :: NSPLOC                             ! W3_MPI
     INTEGER          :: NBFIELD, PDLIB_MPI_TYPE            ! W3_PDLIB
     INTEGER          :: BSTAT(MPIBUF), BISPL(MPIBUF)       ! W3_MPI
     INTEGER, POINTER :: IRQSG1(:,:), IRQSG2(:,:)           ! W3_MPI
     REAL, POINTER    :: GSTORE(:,:), SSTORE(:,:)           ! W3_MPI
     REAL, POINTER    :: SPPNT(:,:,:)
     !
  ...
  !/
  REAL, POINTER :: LANGMT(:), LAPROJ(:), ALPHAL(:)  ! W3_CESMCOUPLED
  ...
  REAL, POINTER       :: FACVX(:), FACVY(:) ! W3_PR1
  !
  INTEGER, POINTER    :: NMX0, NMX1, NMX2, NMY0, NMY1, NMY2, NACT            ! W3_PR2, W3_PR3
  INTEGER, POINTER    :: MAPX2(:), MAPY2(:), MAPAXY(:), MAPTH2(:), MAPWN2(:) ! W3_PR2, W3_PR3
  INTEGER, POINTER    :: MAPXY(:)                                            ! W3_PR2
  INTEGER, POINTER    :: NMXY                                                ! W3_PR2
  INTEGER, POINTER    :: MAPCXY(:)                                           ! W3_PR3
  INTEGER, POINTER    :: NCENT                                               ! W3_PR3
  LOGICAL, POINTER    :: MAPTRN(:)                                           ! W3_PR3
  !
  INTEGER, POINTER    :: ITER(:,:)
  !
  INTEGER, POINTER    :: NFR, NFRHGH, NFRCHG, NSPECX, NSPECY ! W3_NL1
  INTEGER, POINTER    :: IP11(:), IP12(:), IP13(:), IP14(:)  ! W3_NL1
  INTEGER, POINTER    :: IM11(:), IM12(:), IM13(:), IM14(:)  ! W3_NL1
  INTEGER, POINTER    :: IP21(:), IP22(:), IP23(:), IP24(:)  ! W3_NL1
  INTEGER, POINTER    :: IM21(:), IM22(:), IM23(:), IM24(:)  ! W3_NL1
  ...
  INTEGER, POINTER    :: IC51(:), IC52(:), IC61(:), IC62(:)  ! W3_NL1
  INTEGER, POINTER    :: IC71(:), IC72(:), IC81(:), IC82(:)  ! W3_NL1
  REAL, POINTER       :: DAL1, DAL2, DAL3                    ! W3_NL1
  REAL, POINTER       :: AWG1, AWG2, AWG3, AWG4, AWG5, AWG6  ! W3_NL1
  REAL, POINTER       :: AWG7, AWG8, SWG1, SWG2, SWG3, SWG4  ! W3_NL1
  REAL, POINTER       :: SWG5, SWG6, SWG7, SWG8
  REAL, POINTER       :: AF11(:)
  LOGICAL, POINTER    :: NLINIT
  !
  INTEGER, POINTER    :: IAPPRO(:)
  INTEGER, POINTER    :: MPI_COMM_WAVE, MPI_COMM_WCMP   ! W3_MPI
  INTEGER, POINTER    :: WW3_FIELD_VEC, WW3_SPEC_VEC    ! W3_MPI
  INTEGER, POINTER    :: NRQSG1, NRQSG2, IBFLOC, ISPLOC ! W3_MPI
  INTEGER, POINTER    :: NSPLOC                         ! W3_MPI
  INTEGER, POINTER    :: BSTAT(:), BISPL(:)             ! W3_MPI
  INTEGER, POINTER    :: IRQSG1(:,:), IRQSG2(:,:)       ! W3_MPI
  REAL, POINTER       :: GSTORE(:,:), SSTORE(:,:)       ! W3_MPI
  REAL, POINTER       :: SPPNT(:,:,:)
  !
