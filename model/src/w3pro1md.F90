...
CONTAINS
  ...
  SUBROUTINE W3XYP1 ( ISP, DTG, MAPSTA, FIELD, VGX, VGY )
    ...
    ! Formats
    !
9000 FORMAT (' TEST W3XYP1 : NTLOC :',I4) ! W3_T
9001 FORMAT (' TEST W3XYP1 : ISP, ITH, IK :',I8,2I4)
    !
9010 FORMAT (' TEST W3XYP1 : INIT. VFX-YL, ITLOC =',I3) ! W3_T1
    !
9020 FORMAT (' TEST W3XYP1 : ISEA, IXY, FIELD, VCX, VCY') ! W3_T1
...
9033 FORMAT ('            ',I4,E12.4)
    !
9040 FORMAT (' TEST W3XYP1 : PROPAGATION '/                      & ! W3_T3
...
9042 FORMAT (2X,I5,'( MAP = ',I2,' )',56X,2E10.3)
  ...
  SUBROUTINE W3KTP1 ( ISEA, FACTH, FACK, CTHG0, CG, WN, DEPTH,    &
    ...
    USE W3GDATMD, ONLY: ESC, EC2, FACHFA, MAPWN, FLCTH, FLCK, CTMAX
    USE W3ADATMD, ONLY: IS0, IS2
    USE W3IDATMD, ONLY: FLCUR
    USE W3ODATMD, ONLY: NDST
    USE W3ODATMD, only: IAPROC  ! W3_DEBUG
    USE W3SERVMD, ONLY: STRACE ! W3_S
    !/
    IMPLICIT NONE
    !/
    ...
    ! Formats
    !
9000 FORMAT (' TEST W3KTP1 : FLCTH-K, FACTH-K, CTMAX  :',         & ! W3_T
         2L2,2E10.3,F7.3)
