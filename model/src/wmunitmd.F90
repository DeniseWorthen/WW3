...
1020 FORMAT (/' *** WARNING WMUINI: UNIT',I4,' ALREADY ASSIGNED [',  &
         A,'] ***')
    !
9000 FORMAT ( ' TEST WMUNINI: STARTING ROUTINE') ! W3_T
...
1001 FORMAT (/' *** ERROR WMUSET: UNIT NUMBER OUT OF RANGE ***'      &
         /'                   REQ/RANG :',3I6/)
    !
9000 FORMAT ( ' TEST WMUSET: UNIT ',I4', ON SUBROUTINE ENTRY :'/  & ! W3_T
         '              FLAG : ',L4/                         &
         '              TYPE : ',A/                          &
         '              NAME : ',A/                          &
         '              DESC : ' A)
...
1011 FORMAT (/' *** ERROR WMUINQ: UNIT NUMBER OUT OF RANGE ***'      &
         /'                   REQ/RANG :',3I6/)
    !
9010 FORMAT ( ' TEST WMUINQ: TESTING UNIT NUMBER',I4) ! W3_T
