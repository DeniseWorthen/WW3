...
CONTAINS
  ...
  SUBROUTINE W3SNL3 (  A, CG, WN, DEPTH, S, D )
    ...
    USE W3GDATMD , ONLY : NFRMIN, NFRMAX, NFRCUT, NTHMAX, NTHEXP
    USE W3GDATMD , ONLY : NSPMIN, NSPMAX, NSPMX2, FRQ, XSI, NQA
    USE W3GDATMD , ONLY : QST1, QST2, QST3, QST4, QST5, QST6, SNLMSC
    USE W3GDATMD , ONLY : SNLNSC, SNLSFD, SNLSFS
  ...
  SUBROUTINE INSNL3
    ...
    USE CONSTANTS
    USE W3ODATMD , ONLY : NDSE, NDST
    !TODO: the following line allows this module to compile
    USE W3GDATMD,       NFR => NK
    !
