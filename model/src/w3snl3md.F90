...
1011 FORMAT (/' *** WAVEWATCH-III ERROR IN INSNL3 :'/                &
    ...
    !
9010 FORMAT (/' TEST INSNL3: NKD, KDMIN/MAX/X : ',I8,3F10.4) ! W3_T
    !
9020 FORMAT (/' TEST INSNL3: IKD, IQ, KD, F, D: ',2I8,2F10.4,F10.2) ! W3_T1
...
9026 FORMAT ( ' TEST INSNL3: FILLING FIRST DATA TABLES :'/        & ! W3_T
         '              NQA AND MAXIMUM  : ',2I8/            &
         '              NQD AND NQS      : ',2I8)
9027 FORMAT ( '              NFR, MIN/MAX/CUT : ',4I8/            &
         '              NTH, MIN/MAX/EXP : ',4I8)
    !
9030 FORMAT (/' TEST INSNL3: IKD, IQ, KD, F, D: ',2I8,2F10.4,F10.2) ! W3_T2
...
9037 FORMAT (/' TEST INSNL3: STORAGE ARRAYS FOR IKD, IQA =',2I6) ! W3_T3
