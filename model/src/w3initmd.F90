...
CONTAINS
  ...
  SUBROUTINE W3INIT ( IMOD, IsMulti, FEXT, MDS, MTRACE, ODAT, FLGRD,  FLGR2, FLGD, &
    ...
    USE W3GDATMD ,        ONLY : MAPSF, FLAGLL
    USE W3GDATMD ,        ONLY : ICLOSE, ZB, TRNX, TRNY, DMIN, DTCFL, DTMAX
    ...
    USE W3ADATMD ,        ONLY : UA, UD, U10, U10D, AS
#ifdef W3_MPI
    USE W3ADATMD ,        ONLY : MPI_COMM_WAVE, MPI_COMM_WCMP
#endif
    USE W3IDATMD ,        ONLY : FLLEV, FLCUR, FLWIND, FLICE, FLTAUA, FLRHOA
    USE W3IDATMD ,        ONLY : FLMDN, FLMTH, FLMVS, FLIC1, FLIC2, FLIC3
    USE W3IDATMD ,        ONLY : FLIC4, FLIC5
...
9052 FORMAT ('               ',I3,F8.2,F8.4,F8.2)
  ...
  SUBROUTINE W3MPII ( IMOD )
    ...
    USE W3ADATMD , ONLY : WW3_SPEC_VEC, IAPPRO, WADATS
    USE W3ADATMD , ONLY : NRQSG1, IRQSG1, NRQSG2, IRQSG2
    USE W3ADATMD , ONLY : GSTORE, SSTORE, MPIBUF, BSTAT
    USE W3ADATMD , ONLY : BISPL, ISPLOC, IBFLOC, NSPLOC
#endif
...
9033 FORMAT ( ' +------+------+------+------+--------------+',    &
  ...
  SUBROUTINE W3MPIO ( IMOD )
    ...
    USE W3ADATMD , ONLY : DTDYN, FCUT, SPPNT, ABA, ABD, UBA, UBD
    USE W3ADATMD , ONLY : SXX, SYY, SXY, USERO, PHS, PTP, PLP
    USE W3ADATMD , ONLY : PDIR, PSI, PWS, PWST, PNR, PHIAW, PHIOC
    USE W3ADATMD , ONLY : TUSX, TUSY, TAUWIX, TAUWIY, TAUOX
    USE W3ADATMD , ONLY : TAUOY, USSX, USSY, MSSX, MSSY, MSSD
    USE W3ADATMD , ONLY : MSCX, MSCY, MSCD, PRMS, TPMS, CHARN
    USE W3ADATMD , ONLY : TWS, TAUWNX, TAUWNY, BHD, CGE
    USE W3ADATMD , ONLY : CFLXYMAX, CFLTHMAX, CFLKMAX, WHITECAP
    USE W3ADATMD , ONLY : BEDFORMS, PHIBBL, TAUBBL, T01
    USE W3ADATMD , ONLY : P2SMS, US3D, EF,  TH1M, STH1M, TH2M
    USE W3ADATMD , ONLY : STH2M, HSIG, PHICE, TAUICE, USSP
    USE W3ADATMD , ONLY : STMAXE, STMAXD, HMAXE, HCMAXE, HMAXD
    USE W3ADATMD , ONLY : HCMAXD, QP, PTHP0, PQP, PPE, PGW, PSW
    USE W3ADATMD , ONLY : PTM1, PT1, PT2, PEP, WBT, CX, CY
    ...
    USE W3ODATMD , ONLY : NAPFLD, NAPPNT, NAPRST, NAPBPT, NAPTRK
    USE W3ODATMD , ONLY : NOGRP, NGRPP, NOGE, FLOGRR
    USE W3ODATMD , ONLY : OUTPTS, NRQGO, NRQGO2, IRQGO, IRQGO2
    USE W3ODATMD , ONLY : FLOGRD, NRQPO, NRQPO2, IRQPO1, IRQPO2
    USE W3ODATMD , ONLY : NOPTS, IPTINT, NRQRS, IRQRS, NBLKRS
    USE W3ODATMD , ONLY : RSBLKS, IRQRSS, VAAUX, NRQBP, NRQBP2
    USE W3ODATMD , ONLY : IRQBP1, IRQBP2, NFBPO, NBO2, ISBPO
    USE W3ODATMD , ONLY : ABPOS, NRQTR, IRQTR, IT0PNT, IT0TRK
    USE W3ODATMD , ONLY : IT0PRT, NOSWLL, NOEXTR, NDSE, IOSTYP
    USE W3ODATMD , ONLY : FLOGR2
...
9043 FORMAT ( ' TEST W3MPIO: NRQTR :',I10)
  ...
  SUBROUTINE W3MPIP ( IMOD )
    ...
    USE W3ODATMD , ONLY : NOPTS, IPTINT, IT0PNT, IT0TRK, O2IRQI
    USE W3PARALL , ONLY : INIT_GET_JSEA_ISPROC
#endif
    !/
#ifdef W3_MPI
