...
CONTAINS
  ...
  SUBROUTINE W3WDAS ( DASFLAG, RECL, NDAT, DATA0, DATA1, DATA2 )
    ...
    USE W3ODATMD, ONLY: NAPLOG, NAPOUT, NAPERR
    ...
    !/
    INTEGER           :: J
    INTEGER           :: MREC, MDAT, IREC, IDAT ! W3_T
    INTEGER           :: IENT = 0 ! W3_S
    REAL, ALLOCATABLE :: TDATA(:,:) ! W3_T
    !/
    !/ ------------------------------------------------------------------- /
    ...
    !              '                         GRID : ',4I8/)
9000 FORMAT ( ' TEST W3WDAS : UNIT NUMBERS : ',4I4/               & ! W3_T
         '               MPI SETTINGS : ',4I4/               &
         '               TIME         : ',I8.8,I7.6)
...
9003 FORMAT (19X,   6E10.3)
    !
9010 FORMAT ( ' TEST W3WDAS : ARRAY DIMS.  : ',6I8/               & ! W3_T
         '               GRID         : ',1I2,1L2,4E11.4)
    !/
    !/ End of W3WDAS ----------------------------------------------------- /
    !/
