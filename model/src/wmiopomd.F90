...
CONTAINS
  ...
  SUBROUTINE WMIOPP ( NPT, XPT, YPT, PNAMES )
    ...
    USE W3GDATMD, ONLY: FLAGLL, ICLOSE, ICLOSE_NONE, GTYPE, UNGTYPE
    USE W3GDATMD, ONLY: CLGTYPE, GSU
