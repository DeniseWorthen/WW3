...
PROGRAM GXOUTF
  ...
  USE W3ADATMD , ONLY : DW, HS, WLM, T01, T0M1, T02, THM, THS, FP0
  USE W3ADATMD , ONLY : THP0, ABA, ABD, UBA, UBD, FCUT
  USE W3ADATMD , ONLY : SXX, SYY, SXY, PHS, PTP, PLP, PDIR, PSI, PWS
  USE W3ADATMD , ONLY : PTM1, PT1, PT2, PEP, TAUA, TAUADIR
  USE W3ADATMD , ONLY : PTHP0, PQP, PSW, PPE, PGW, QP
  USE W3ADATMD , ONLY : PWST, PNR, USERO, TAUOX, TAUOY, TAUWIX
  USE W3ADATMD , ONLY : TAUWIY, PHIAW, PHIOC, TUSX, TUSY, PRMS, TPMS
  USE W3ADATMD , ONLY : USSX, USSY, MSSX, MSSY, MSCX, MSCY, CHARN
  USE W3ADATMD , ONLY : TAUWNX,  TAUWNY, BHD, P2SMS, DTDYN
  USE W3ADATMD , ONLY : CGE, T02, BEDFORMS, WHITECAP, TAUBBL, PHIBBL
  USE W3ADATMD , ONLY : CFLXYMAX, CFLTHMAX, CFLKMAX, US3D, STMAXE
  USE W3ADATMD , ONLY : STMAXD, HMAXE, HCMAXE, HMAXD, HCMAXD, WBT
  USE W3ODATMD , ONLY : NDSE, NDST, NDSO, NOGRP, NGRPP, IDOUT, UNDEF
  USE W3ODATMD , ONLY : FLOGRD, FNMPRE, NOSWLL, NOGE
  !
  IMPLICIT NONE
  !/
  !/ ------------------------------------------------------------------- /
