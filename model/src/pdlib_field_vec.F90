...
CONTAINS
  ...
  SUBROUTINE DO_OUTPUT_EXCHANGES(IMOD)
    ...
    USE W3ADATMD    , ONLY : PDIR, PSI, PWS, PWST, PNR, PHIAW
    USE W3ADATMD    , ONLY : PHIOC, TAUOCX, TAUOCY, WNMEAN
    USE W3ADATMD    , ONLY : TUSX, TUSY, TAUWIX, TAUWIY, TAUOX
    USE W3ADATMD    , ONLY : TAUOY, USSX, USSY, MSSX, MSSY
    USE W3ADATMD    , ONLY : MSCX, MSCY, PRMS, TPMS, CHARN
    USE W3ADATMD    , ONLY : TAUWNX, TAUWNY, BHD, CGE
    ...
    USE W3ADATMD    , ONLY : STH2M, HSIG, TAUICE, PHICE, PTHP0, PQP
    USE W3ADATMD    , ONLY : PPE, PGW, PSW, PTM1, PT1, PT2, PEP
    USE W3ADATMD    , ONLY : QP, MSSD, MSCD, STMAXE, STMAXD, HMAXE
    USE W3ADATMD    , ONLY : HCMAXE, HMAXD, HCMAXD, WBT
