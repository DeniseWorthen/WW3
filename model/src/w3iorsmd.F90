...
CONTAINS
  ...
  SUBROUTINE W3IORS ( INXOUT, NDSR, DUMFPI, IMOD, FLRSTRT )
    ...
    USE W3ADATMD  , ONLY : TAUWIX, TAUWIY, TWS, TAUOX, TAUOY, BHD
    USE W3ADATMD  , ONLY : PHIOC, TUSX, TUSY, USSX, USSY, TAUICE
    USE W3ADATMD  , ONLY : UBA, UBD, PHIBBL, TAUBBL, TAUOCX, TAUOCY
    USE W3ADATMD  , ONLY : WNMEAN
    !/
    USE W3GDATMD  , ONLY : NX, NY, NSEA, NSEAL, NSPEC, MAPSTA, MAPST2
    USE W3GDATMD  , ONLY : GNAME, FILEXT, GTYPE, UNGTYPE
    ...
    USE W3ODATMD  , ONLY : IFILE => IFILE4, FNMPRE, NTPROC, IOSTYP
    USE W3ODATMD  , ONLY : FLOGRR, NOGRP, NGRPP, SCREEN
#ifdef W3_MPI
    USE W3ODATMD  , ONLY : NRQRS, NBLKRS, RSBLKS, IRQRS, IRQRSS
    USE W3ODATMD  , ONLY : VAAUX
