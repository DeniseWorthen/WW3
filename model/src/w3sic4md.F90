...
1001 FORMAT (/' *** WAVEWATCH III ERROR IN W3SIC4 : '/               &
    ...
    !
9000 FORMAT (' TEST W3SIC4 : DEPTH,ICECOEF1  : ',2E10.3) ! W3_T
    !/
    !/ End of W3SIC4 --------------------------------------------------- /
    !/
