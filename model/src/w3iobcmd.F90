...
CONTAINS
  ...
  SUBROUTINE W3IOBC ( INXOUT, NDSB, TIME1, TIME2, IOTST, IMOD )
    ...
    USE W3GDATMD , ONLY : X0, Y0, SX, SY, GSU, MAPSTA, MAPFS, MAPSF
    USE W3GDATMD , ONLY : XFR, FR1, SIG2, TH, DTH, FILEXT, FACHFE
    USE W3GDATMD , ONLY : GTYPE, UNGTYPE, SMCTYPE
    ...
    USE W3ODATMD , ONLY : NBI, NBI2, NFBPO, NBO, NBO2, NDSL
    USE W3ODATMD , ONLY : NKI, NTHI, XFRI, FR1I, TH1I
    USE W3ODATMD , ONLY : IPBPI, ISBPI, XBPI, YBPI, RDBPI
    USE W3ODATMD , ONLY : IPBPO, ISBPO, XBPO, YBPO, RDBPO
    USE W3ODATMD , ONLY : ABPI0, ABPIN, ABPOS, FLBPI, FILER, FILEW
    USE W3ODATMD , ONLY : FILED, SPCONV, FNMPRE
    USE W3GSRUMD
    !
