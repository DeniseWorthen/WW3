...
CONTAINS
  ...
  SUBROUTINE W3SNL1 (A, CG, KDMEAN, S, D)
    ...
    USE W3GDATMD, ONLY: KDCON, KDMN, SNLC1, SNLS1, SNLS2, SNLS3
    USE W3ADATMD, ONLY: NFR, NFRHGH, NFRCHG, NSPECX, NSPECY
    USE W3ADATMD, ONLY: IP11, IP12, IP13, IP14, IM11, IM12, IM13, IM14
    USE W3ADATMD, ONLY: IP21, IP22, IP23, IP24, IM21, IM22, IM23, IM24
    USE W3ADATMD, ONLY: IC11, IC12, IC21, IC22, IC31, IC32, IC41, IC42
    USE W3ADATMD, ONLY: IC51, IC52, IC61, IC62, IC71, IC72, IC81, IC82
    USE W3ADATMD, ONLY: DAL1, DAL2, DAL3, AF11
    USE W3ADATMD, ONLY: AWG1, AWG2, AWG3, AWG4, AWG5, AWG6, AWG7, AWG8
    USE W3ADATMD, ONLY: SWG1, SWG2, SWG3, SWG4, SWG5, SWG6, SWG7, SWG8
    !!/DEBUGSRC      USE W3ODATMD, only : IAPROC
    USE W3ODATMD, ONLY: NDST   ! W3_T
    USE W3ODATMD, ONLY: NDST   ! W3_T1
    USE W3SERVMD, ONLY: STRACE ! W3_S
    USE W3ARRYMD, ONLY: PRT2DS ! W3_T0
    USE W3ARRYMD, ONLY: OUTMAT ! W3_T1
    !
    IMPLICIT NONE
    !/
    !/ ------------------------------------------------------------------- /
    ...
    REAL    :: SOUT(NK,NFR), DOUT(NK,NFR) ! W3_T0
    ...
    ! Formats
    !
9000 FORMAT (' TEST W3SNL1 : KDMEAN, CONS :',F8.2,F8.1) ! W3_T
    !/
    !/ End of W3SNL1 ----------------------------------------------------- /
    !/
  ...
  SUBROUTINE INSNL1 ( IMOD )
    ...
    ! Formats
    !
9000 FORMAT (' TEST INSNL1 : IMOD :',I4) ! W3_T
    !/
    !/ End of INSNL1 ----------------------------------------------------- /
    !/
