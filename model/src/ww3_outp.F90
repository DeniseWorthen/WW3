...
PROGRAM W3OUTP
  ...
  USE W3ODATMD , ONLY : DPO, WAO, WDO, ASO, CAO, CDO, SPCO, FNMPRE
  USE W3ODATMD , ONLY : ICEO, ICEHO, ICEFO, DIMP
#ifdef W3_FLX5
  USE W3ODATMD , ONLY : TAUAO, TAUDO, DAIRO
#endif
  USE W3BULLMD , ONLY : NPTAB, NFLD, NPMAX, BHSMIN, BHSDROP, IYY
  USE W3BULLMD , ONLY : HST, TPT, DMT, ASCBLINE, CSVBLINE
#ifdef W3_NCO
  ...
  INTEGER              :: IERR, I, TOUT(2), NOUT, TDUM(2)
  INTEGER              :: NREQ, IPOINT, ITYPE, OTYPE, NDSTAB
  INTEGER              :: IOTEST, IK, ITH, IOUT, J, DIMXP
  INTEGER              :: NDSBUL, NDSCSV, ICSV, IJ
#ifdef W3_NCO
  INTEGER              :: NDSCBUL
#endif
  INTEGER              :: ISCALE = 0
...
!>
  SUBROUTINE W3EXPO
    ...
    INTEGER            :: IK, IH, IM, IS, IYR, IMTH, IDY, ITT
    INTEGER            :: I, NPART, IP, IX, IY, ISEA
    ...
    REAL               :: FMEAN, WNMEAN, UDIRCA, X, Y, CHARN
    REAL               :: M2KM, ICEF, ICEDMAX, ICETHICK
    REAL               :: ICECON
#ifdef W3_FLX5
