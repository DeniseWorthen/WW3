...
CONTAINS
  ...
  SUBROUTINE W3PSMC ( ISP, DTG, VQ )
    ...
    USE W3GDATMD , ONLY : IJKCel3, IJKCel4
    USE W3GDATMD , ONLY : IJKVFc5, IJKVFc6,IJKUFc5,IJKUFc6
...
9041 FORMAT (1X,I6,2I5,E12.4)
  ...
  SUBROUTINE W3KRTN ( ISEA, FACTH, FACK, CTHG0, CG, WN, DEPTH,    &
    ...
    REAL ,    INTENT(IN)    :: FACTH, FACK, CTHG0, CG(0:NK+1), WN(0:NK+1), DEPTH
    REAL ,    INTENT(IN)    :: DDDX, DDDY, ALFLMT(NTH), CX, CY, DCXDX, DCXDY
  ...
  SUBROUTINE SMCGradn(CVQ, GrdX, GrdY, L0r1)
    ...
    USE W3GDATMD , ONLY : IJKCel, IJKUFc, IJKVFC, CLATS, SX, SY
