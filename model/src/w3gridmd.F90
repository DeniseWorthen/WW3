...
MODULE W3GRIDMD
  ...
  USE W3SERVMD, ONLY: W3EQTOLL, W3LLTOEQ ! W3_RTD
  USE W3SERVMD, ONLY: W3LLTOEQ           ! W3_SMC
  USE W3SERVMD, ONLY: STRACE             ! W3_S
  USE W3ARRYMD, ONLY: INA2R, INA2I
  USE W3ARRYMD, ONLY: PRTBLK             ! W3_T
  ...
  INTEGER              :: IDEPTH                                       ! W3_NL2
  INTEGER              :: IBI, IP0, IPN, IPH, IPI                      ! W3_O1
  INTEGER              :: NCOL =  78
  ...
  INTEGER              :: JEQT, LvSMC, NBISMC, JS, NCObst, JObs, ISHFT ! W3_SMC
  INTEGER              :: NGUI, NGVJ,  NAUI, NAVJ                      ! W3_SMC
  !
  INTEGER              :: NMAP, IMAP                                   ! W3_O2
  INTEGER              :: IX3, IY3                                     ! W3_T
  INTEGER              :: IFILE                                        ! W3_T0
  ...
  REAL    :: STK_WN(25) ! STK_WN are the decays for Stokes drift partitions

  INTEGER :: nbCase1, nbCase2, nbCase3       ! W3_DEBUGGRID
  INTEGER :: nbCase4, nbCase5, nbCase6       ! W3_DEBUGGRID
  INTEGER :: nbCase7, nbCase8                ! W3_DEBUGGRID
  INTEGER :: nbTMPSTA0, nbTMPSTA1, nbTMPSTA2 ! W3_DEBUGGRID
  INTEGER :: IAPROC                          ! W3_DEBUGGRID
  !
  REAL :: CLIN, RFPM, RFHF              ! W3_LN1
  REAL :: CINP, CDIS, APM               ! W3_ST1
  REAL :: PHIMIN, FPIA, FPIB, DPHID     ! W3_ST2
  REAL :: NLPROP                        ! W3_NL1
  REAL :: DPTFAC, DEPTHS(100)           ! W3_NL2
  REAL :: QPARMS(500)                   ! W3_NL3
  REAL :: A34, FHFC, DNM, FC1, FC2, FC3 ! W3_NLS
  REAL :: GAMMA                         ! W3_BT1
  REAL :: LATMIN                        ! W3_PR2
  !
  REAL                 :: TRNMX, TRNMY                                             ! W3_SMC
  INTEGER, ALLOCATABLE :: NLvCelsk(:),  NLvUFcsk(:),  NLvVFcsk(:)                  ! W3_SMC
  INTEGER, ALLOCATABLE :: IJKCelin(:,:),IJKUFcin(:,:),IJKVFcin(:,:)                ! W3_SMC
  INTEGER, ALLOCATABLE :: NBICelin(:),  IJKObstr(:,:)                              ! W3_SMC
  REAL                 :: PoLonAC, PoLatAC                                         ! W3_SMC
  INTEGER, ALLOCATABLE :: IJKCelAC(:,:),IJKUFcAC(:,:),IJKVFcAC(:,:)                ! W3_SMC
  REAL,    ALLOCATABLE :: XLONAC(:),YLATAC(:),ELONAC(:),ELATAC(:)                  ! W3_SMC
  !
  REAL, ALLOCATABLE    :: AnglDin(:,:),StdLon(:,:),StdLat(:,:)                     ! W3_RTD
  REAL, ALLOCATABLE    :: BDYLON(:), BDYLAT(:), ELatbdy(:), ELonbdy(:), Anglbdy(:) ! W3_RTD
  ! If the destination grid for an output b.c. is rotated, its pole is:
  REAL                 :: bPolat, bPolon                                           ! W3_RTD
  !!
  ...
  REAL    :: ISC1, ISC2                      ! W3_IS1, W3_IS2
  REAL    :: is2c2                           ! W3_IS2 new definition
  REAL    :: IS2BACKSCAT, IS2C3              ! W3_IS2
  REAL    :: IS2FRAGILITY, IS2DMIN, IS2DAMP  ! W3_IS2
  REAL    :: IS2CONC, IS2CREEPB, IS2CREEPC   ! W3_IS2
  REAL    :: IS2CREEPD, IS2CREEPN, IS2BREAKE ! W3_IS2
  REAL    :: IS2WIM1, IS2BREAKF, IS2FLEXSTR  ! W3_IS2
  REAL    :: IS2ANDISN, IS2ANDISE, IS2ANDISD ! W3_IS2
  LOGICAL :: IS2BREAK, IS2DISP, IS2DUPDATE   ! W3_IS2
  LOGICAL :: IS2ISOSCAT, IS2ANDISB           ! W3_IS2
  !
  REAL :: REFCOAST, REFFREQ, REFMAP    ! W3_REF1
  REAL :: REFSUBGRID, REFRMAX, REFMAPD ! W3_REF1
  REAL :: REFICEBERG, REFCOSP_STRAIGHT ! W3_REF1
  REAL :: REFFREQPOW, REFUNSTSOURCE    ! W3_REF1
  !
  LOGICAL :: IGSWELLMAX, IGBCOVERWRITE                                         ! W3_IG1
  INTEGER :: IGMETHOD, IGADDOUTP, IGSOURCE, IGSOURCEATBP, IGSTERMS             ! W3_IG1
  REAL    :: IGMAXFREQ, IGMINDEP, IGMAXDEP, IGKDMIN, IGFIXEDDEPTH, IGEMPIRICAL ! W3_IG1
  !

  LOGICAL :: IC2DISPER                             ! W3_IC2
  REAL    :: IC2TURB, IC2ROUGH, IC2REYNOLDS        ! W3_IC2, W3_IC3
  REAL    :: IC2SMOOTH, IC2VISC, IC2TURBS          ! W3_IC2, W3_IC3
  REAL    :: IC2DMAX                               ! W3_IC2

  REAL    :: IC3MAXTHK, IC3MAXCNC               ! W3_IC3
  REAL    :: IC3HILIM, IC3KILIM                 ! W3_IC3
  REAL    :: IC3VISC, IC3ELAS, IC3DENS, IC3HICE ! W3_IC3
  LOGICAL :: IC3CHENG,USECGICE                  ! W3_IC3
  !
  INTEGER :: IC4METHOD                ! W3_IC4
  REAL    :: IC4KI(NIC4), IC4FC(NIC4) ! W3_IC4
  !
  REAL              :: IC5MINIG, IC5MINWT                      ! W3_IC5
  REAL              :: IC5MAXKRATIO, IC5MAXKI, IC5MINHW        ! W3_IC5
  REAL              :: IC5MAXITER, IC5RKICK, IC5KFILTER        ! W3_IC5
  REAL              :: IC5VEMOD                                ! W3_IC5
  CHARACTER(LEN=4)  :: IC5MSTR(3) = (/' EFS', ' RP ', ' M2 '/) ! W3_IC5
  ...
  CHARACTER :: PMNAME*45, PMNAM2*45                                           ! Part. method desc.
                                                                              !
  INTEGER   :: TAILTYPE                                                       ! W3_FLD1, W3_FLD2
  REAL      :: TAILLEV, TAILT1, TAILT2                                        ! W3_FLD1
                                                                              !
  INTEGER   :: CTYPE                                                          ! W3_FLX3
  REAL      :: CDMAX                                                          ! W3_FLX3
                                                                              !
  REAL      :: CDFAC                                                          ! W3_FLX4
                                                                              !
  REAL      :: ZWND, SWELLF                                                   ! W3_ST2, W3_ST3, W3_ST4
 ...
 !REAL      :: SDSC1                                                          ! W3_ST3 PROBLEM (MV) this conflicts with use case from w3gdatmd
  ...
  REAL      :: Z0RAT, TAUWSHELTER                                             ! W3_ST4
  REAL      :: SWELLF2,SWELLF3,SWELLF4, SWELLF5                               ! W3_ST4
  REAL      :: SWELLF6, SWELLF7                                               ! W3_ST4
  REAL      :: SINBR, FXFMAGE                                                 ! W3_ST4
  REAL      :: SDSC2, SDSCUM, SDSC4, SDSC5, SDSC6, WHITECAPWIDTH, WHITECAPDUR ! W3_ST4
  REAL      :: SDSSTRAIN, SDSSTRAINA, SDSSTRAIN2                              ! W3_ST4
  REAL      :: SDSBR, SDSP, SDSBT, SDS4A, SDKOF                               ! W3_ST4
  REAL      :: SDSCOS, SDSDTH, SDSBCK, SDSABK                                 ! W3_ST4
  REAL      :: SDSPBK, SDSBINT, SDSHCK                                        ! W3_ST4
  REAL      :: SDSBRF1                                                        ! W3_ST4
  ...
  LOGICAL   :: SDSET, CSTB1                                                   ! W3_ST6

  REAL      :: LAMBDA, KDCONV, KDMIN, SNLCS1, SNLCS2, SNLCS3                  ! W3_NL1

  INTEGER   :: IQTYPE, NDEPTH                                                 ! W3_NL2
  REAL      :: TAILNL                                                         ! W3_NL2

  INTEGER   :: NQDEF                                                          ! W3_NL3
  REAL      :: MSC, NSC, KDFD, KDFS                                           ! W3_NL3

  INTEGER   :: INDTSA, ALTLP                                                  ! W3_NL4

  REAL      :: NL5DPT, NL5OML                                                 ! W3_NL5
  INTEGER   :: NL5DIS, NL5KEV, NL5IPL, NL5PMX                                 ! W3_NL5

  REAL      :: BJALFA, BJGAM                                                  ! W3_DB1
  LOGICAL   :: BJFLAG                                                         ! W3_DB1
  
  REAL      :: DTIME                                                          ! W3_PR2
  
  REAL      :: DTIMS, CFLSM, RFMAXD, SYMR, YJ0R                               ! W3_SMC
  LOGICAL   :: UNO3, AVERG, SEAWND, Arctic                                    ! W3_SMC
  CHARACTER :: PNSMC*30                                                       ! W3_SMC
  !
  REAL      :: WDTHCG, WDTHTH                                                 ! W3_PR3
  !
  ...
  REAL      :: UGOBCDEPTH 
  LOGICAL   :: UGOBCOK
  REAL      :: PLAT, PLON   ! W3_RTD
  LOGICAL   :: UNROT        ! W3_RTD
  ! Poles of the output nested grids. May be a mix of rotated and standard
  REAL, DIMENSION(9) :: BPLAT, BPLON ! W3_RTD
  !
  ! W3_FLD1
  ...
  ! W3_ST3
  NAMELIST /SIN3/ ZWND, ALPHA0, Z0MAX, BETAMAX, SINTHP, ZALP, SWELLF
  ...
  ! W3_ST3
  NAMELIST /SDS3/ SDSC1, WNMEANP, FXPM3, FXFM3, SDSDELTA1, SDSDELTA2
  ...
  ! W3_IS2
  ! PROBLEM (MV) IS2C2 is not defined
...
CONTAINS
  ...
  SUBROUTINE W3GRID()
    ...
    ! 6.d.1 Stresses
    !
    if (w3_flx1_flag) then
       WRITE (NDSO,8101)
    end if
    !
    if (w3_flx2_flag) then
       WRITE (NDSO,8102)
       CINXSI =    0.20
       NITTIN =    3
    end if
    !
    if (w3_flx3_flag) then
       CINXSI =    0.20
       NITTIN =    3
       CDMAX  =    2.5E-3
       CTYPE  =    0
       CALL READNL ( NDSS, 'FLX3', STATUS )
       WRITE (NDSO,8103) STATUS
       CDMAX  = MAX ( 0. , CDMAX )
       IF ( CTYPE .EQ. 1 ) THEN
       ...
       END IF
       WRITE (NDSO,8113) CDMAX*1.E3, TYPEID
       CD_MAX =    CDMAX
       CAP_ID =    CTYPE
    end if
    !
    if (w3_flx4_flag) then
       CDFAC  = 1.0
       CALL READNL ( NDSS, 'FLX4', STATUS )
       WRITE (NDSO,8104) STATUS
       WRITE (NDSO,8114) CDFAC
       FLX4A0 = CDFAC
    end if
    !
    if (w3_flx5_flag) then
       WRITE (NDSO,8105)
    end if
    !
    ! 6.d.2 Linear input
    ...
    if (w3_ln1_flag) then
       ...
       WRITE (NDSO,8201) STATUS
       CLIN   = MAX (0.,CLIN)
       RFPM   = MAX (0.,RFPM)
       RFHF   = MAX(0.,MIN (1.,RFHF))
       WRITE (NDSO,8211) CLIN, RFPM, RFHF
    ...
    if (w3_st1_flag) then
       ...
       WRITE (NDSO,9201) STATUS
       WRITE (NDSO,9211) CINP
       SINC1  = 28. * CINP * DAIR / DWAT
    end if
    !
    if (w3_st2_flag) then
       CALL READNL ( NDSS, 'SIN2', STATUS )
       WRITE (NDSO,9202) STATUS
       IF ( SWELLF.LT.0. .OR. SWELLF.GT.1. ) SWELLF = 1.
       WRITE (NDSO,9212) ZWND, SWELLF
    ...
    if (w3_st3_flag) then
       ...
       WRITE (NDSO,9203) STATUS
       WRITE (NDSO,9213) ALPHA0, BETAMAX, SINTHP, Z0MAX, ZALP, ZWND, SWELLF
       ZZWND      = ZWND
       AALPHA     = ALPHA0
       BBETA      = BETAMAX
       SSINTHP    = SINTHP
    ...
    if (w3_st4_flag) then
       ...
       WRITE (NDSO,9204) STATUS
       WRITE (NDSO,9214) ALPHA0, BETAMAX, SINTHP, Z0MAX, ZALP, ZWND, TAUWSHELTER, &
    ...
    if (w3_st6_flag) then
       ...
       WRITE (NDSO,9206) STATUS
       SIN6A0 = SINA0
       SIN6WS = SINWS
       SIN6FC = SINFC
       J = 1
       IF ( SIN6A0.LE.0. ) J = 2
       WRITE (NDSO,9216) YESXNO(J), SIN6A0, SIN6WS, SIN6FC
    end if
    !
    ! 6.e Define Snl.
    !
    ...
    if (w3_nl1_flag) then
       ...
       WRITE (NDSO,9221) STATUS
       WRITE (NDSO,9231) LAMBDA, NLPROP, KDCONV, KDMIN, &
            SNLCS1, SNLCS2, SNLCS3
       SNLC1  = NLPROP / GRAV**4
       LAM    = LAMBDA
       KDCON  = KDCONV
    ...
    if (w3_nl2_flag) then
       ...
       WRITE (NDSO,9222) STATUS
       TAILNL = MIN ( MAX ( TAILNL, -5. ) , -4. )
       IF ( IQTYPE .EQ. 3 ) THEN
          WRITE (NDSO,9232) 'Shallow water', TAILNL
       ELSE IF ( IQTYPE .EQ. 2 ) THEN
          WRITE (NDSO,9232) 'Deep water with scaling', TAILNL
       ELSE
          WRITE (NDSO,9232) 'Deep water', TAILNL
          IQTYPE = 1
       END IF
       !
       IF ( IQTYPE .NE. 3 ) THEN
       ...
       ELSE
          ...
          WRITE (NDSO,19232) NDEPTH, DPTHNL(1:MIN(5,NDEPTH))
          IF (NDEPTH .GT. 5 )WRITE (NDSO,29232) DPTHNL(6:NDEPTH)
       END IF
       WRITE (NDST,*)
       IQTPE  = IQTYPE
       NDPTHS = NDEPTH
    ...
    if (w3_nl4_flag) then
       ...
       WRITE (NDSO,9224) STATUS
       WRITE (NDSO,9234) INDTSA, ALTLP
       ITSA = INDTSA
       IALT = ALTLP
    end if
    !
    if (w3_nl5_flag) then
       ...
       WRITE (NDSO,9235) NL5DPT, NL5OML, NL5DIS, NL5KEV, NL5IPL, NL5PMX
       QR5DPT = NL5DPT
       QR5OML = NL5OML
       QI5DIS = NL5DIS
       QI5KEV = NL5KEV
    ...
    if (w3_st1_flag) then
       ...
       WRITE (NDSO,9241) STATUS
       WRITE (NDSO,9251) CDIS, APM
       SDSC1  = TPI * CDIS / APM**2
    end if
    !
    if (w3_st2_flag) then
       CALL READNL ( NDSS, 'SDS2', STATUS )
       WRITE (NDSO,9242) STATUS
       IF ( PHIMIN .LE. 0. ) THEN
          SDSB2  = 0.
          SDSB3  = 0.
       ...
       ELSE
          ...
          END IF
       END IF
       WRITE (NDSO,9252) SDSA0, SDSA1, SDSA2,                      &
    ...
    if (w3_st3_flag) then
       ...
       WRITE (NDSO,9243) STATUS
       WRITE (NDSO,9253) SDSC1, WNMEANP, SDSDELTA1,  &
            SDSDELTA2
       SSDSC1   = SDSC1
       WWNMEANP   = WNMEANP
       FFXFM = FXFM3 * TPI
    ...
    if (w3_st4_flag) then
       ...
       WRITE (NDSO,9244) STATUS
       WRITE (NDSO,9254) SDSC2, SDSBCK, SDSCUM, WNMEANP 
    ...
    if (w3_st6_flag) then
       ...
       J = 2
       IF (SDSET) J = 1
       WRITE (NDSO,9256) YESXNO(J), YESXNO(3-J), SDS6A1, SDS6P1, SDS6A2, SDS6P2
    ...
    if (w3_bt1_flag) then
       ...
       WRITE (NDSO,9261) STATUS
       WRITE (NDSO,9271) GAMMA
       SBTC1  = 2. * GAMMA / GRAV
    end if
    !
    if (w3_bt4_flag) then
       ...
       WRITE (NDSO,9264) STATUS
       WRITE (NDSO,9274) SEDMAPD50, SED_D50_UNIFORM, &
    ...
    if (w3_pr2_flag) then
       ...
       IF ( DTIME .EQ. 0. ) THEN
          WRITE (NDSO,9532) CFLTM, LATMIN
       ELSE
          WRITE (NDSO,9542) CFLTM, DTIME/3600., LATMIN
       END IF
       DTME   = DTIME
    end if
    !
    ...
    IF (GTYPE.NE.UNGTYPE) THEN
       if (w3_pr3_flag) then
          WRITE (NDSO,952) STATUS(1:18)
          CFLTM  = MAX ( 0. , CFLTM )
          WRITE (NDSO,9533) CFLTM, WDTHCG
          IF ( WDTHCG*(XFR-1.) .GT. 1. ) WRITE (NDSO,955) 1./(XFR-1.)
          WRITE (NDSO,9543) WDTHTH
    ...
    FACSD  = XSEED
    if (w3_rwnd_flag) then
       RWINDC = RWNDC 
    end if
    if (w3_wcor_flag) then
       WWCOR(1) = WCOR1 
       WWCOR(2) = WCOR2 
    end if
    !
    ...
    !
    if (w3_fld1_flag) then
       TAILTYPE = 0
       TAILLEV  = 0.006
       TAILT1 = 1.25
       TAILT2 = 3.00
    end if
    if (w3_fld2_flag) then
       TAILTYPE = 0
       TAILLEV  = 0.006
       TAILT1 = 1.25
       TAILT2 = 3.00
    ...
    IF ( FLNMLO ) THEN
       WRITE (NDSO,917)
       if (w3_flx3_flag) then
          WRITE (NDSO,28103) CDMAX*1.E3, CTYPE
       end if
       if (w3_flx4_flag) then
          WRITE (NDSO,28104) CDFAC
       end if
       if (w3_ln1_flag) then
          WRITE (NDSO,2820) CLIN, RFPM, RFHF
       end if
       if (w3_st1_flag) then
          WRITE (NDSO,29201) CINP
       end if
       IF ( .NOT. FLSTB2 ) THEN
          if (w3_st2_flag) then
             WRITE (NDSO,29202) ZWND, SWELLF
          end if
       ELSE
          if (w3_stab2_flag) then
             WRITE (NDSO,2921) ZWND, SWELLF, STABSH, STABOF, CNEG, CPOS, FNEG
          end if
       END IF
       !
       if (w3_st3_flag) then
          WRITE (NDSO,29203) ZWND, ALPHA0, Z0MAX, BETAMAX, SINTHP, ZALP, SWELLF
       end if
       if (w3_st4_flag) then
          WRITE (NDSO,29204) ZWND, ALPHA0, Z0MAX, BETAMAX, SINTHP, ZALP,   &
               TAUWSHELTER, SWELLFPAR, SWELLF, SWELLF2, SWELLF3, SWELLF4, &
               SWELLF5, SWELLF6, SWELLF7, Z0RAT, SINBR
       end if
       if (w3_st6_flag) then
          WRITE (NDSO,29206) SINA0, SINWS, SINFC
       end if
       if (w3_nl1_flag) then
          WRITE (NDSO,29221) LAMBDA, NLPROP, KDCONV, KDMIN,       &
               SNLCS1, SNLCS2, SNLCS3
       end if
       if (w3_nl2_flag) then
          WRITE (NDSO,29222) IQTYPE, TAILNL, NDEPTH
          IF ( IQTYPE .EQ. 3 ) THEN
             IF ( NDEPTH .EQ. 1 ) THEN
                WRITE (NDSO,39232) DPTHNL(1)
             ELSE
                WRITE (NDSO,49232) DPTHNL(1)
             END IF
             WRITE (NDSO,59232) DPTHNL(2:NDEPTH-1)
             WRITE (NDSO,69232) DPTHNL(NDEPTH)
          END IF
       end if
       if (w3_nl3_flag) then
          WRITE (NDSO,29223) NQDEF, MSC, NSC, KDFD, KDFS
          IF ( NQDEF .EQ. 1 ) THEN
             WRITE (NDSO,39233) QPARMS(1:5)
          ELSE
             WRITE (NDSO,49233) QPARMS(1:5)
             DO J=2, NQDEF-1
                WRITE (NDSO,59233) QPARMS((J-1)*5+1:J*5)
             END DO
             WRITE (NDSO,69233) QPARMS((NQDEF-1)*5+1:NQDEF*5)
          END IF
       end if
       if (w3_nl4_flag) then
          WRITE (NDSO,29224) INDTSA, ALTLP
       end if
       if (w3_nl5_flag) then
          WRITE (NDSO,29225) QR5DPT, QR5OML, QI5DIS, QI5KEV, QI5IPL, QI5PMX
       end if
       if (w3_nls_flag) then
          WRITE (NDSO,8922) A34, FHFC, DNM, FC1, FC2, FC3
       end if
       if (w3_st1_flag) then
          WRITE (NDSO,29241) CDIS, APM
       end if
       if (w3_st2_flag) then
          WRITE (NDSO,29242) SDSA0, SDSA1, SDSA2, SDSB0, SDSB1, PHIMIN
       end if
       if (w3_st3_flag) then
          WRITE (NDSO,29243) SDSC1, WNMEANP, FXPM3, FXFM3, SDSDELTA1,  &
               SDSDELTA2
       end if
       ...
       if (w3_bt1_flag) then
          WRITE (NDSO,29261) GAMMA
       end if
       if (w3_bt4_flag) then
          WRITE (NDSO,29264) SEDMAPD50, SED_D50_UNIFORM,      &
               RIPFAC1,RIPFAC2,RIPFAC3,RIPFAC4, SIGDEPTH, &
               BOTROUGHMIN, BOTROUGHFAC
       end if
       if (w3_db1_flag) then
       ...
       if (w3_pr1_flag) then
          WRITE (NDSO,29531) CFLTM
       end if
       if (w3_pr2_flag) then
          WRITE (NDSO,29532) CFLTM, DTIME, LATMIN
       end if
       if (w3_smc_flag) then
       ...
       if (w3_pr3_flag) then
          WRITE (NDSO,29533) CFLTM, WDTHCG, WDTHTH
       end if
       !
    ...
    DO ILOOP = 1, 2
       ...
       DO
          ...
          !
          ! PROBLEM(MV) - previous code had END DO buried inside the ifdef without the 
          ! corresponding do 
          if (w3_rtd_flag) then
             DO IP=1, NPO
             ...
             IF ( bPolat < 90. ) THEN
                ...
                ELonbdy(:) = BDYLON(:)
                !
                CALL W3EQTOLL ( ELatbdy, ELonbdy, BDYLAT, BDYLON, Anglbdy, bPolat, bPolon, NPO )
                !
             ...
             IF ( Polat < 90. ) THEN
                ...
                CALL W3LLTOEQ ( BDYLAT, BDYLON, ELatbdy, ELonbdy, Anglbdy, Polat, Polon, NPO )
             END IF
          end if ! if (w3_rtd_flag)
          !
          ...
          DO IP=1, NPO
             ...
             !
             if (w3_t_flag) then
                WRITE (NDST,9091) FACTOR*XO, FACTOR*YO, (IXR(J), IYR(J), RD(J), J=1,4)
             end if
             !
             ! ... Check if point in grid
             !
...
!
! W3_FLX1
  8101 FORMAT (/'  Stresses (Wu 1980)'/                          &
        ' --------------------------------------------------'/)
! W3_FLX2
  8102 FORMAT (/'  Stresses (T&C 96)'/                           &
        ' --------------------------------------------------'/)
! W3_FLX3
  8103 FORMAT (/'  Stresses (T&C 96 capped) ',A/                 &
        ' --------------------------------------------------')

! W3_FLX4
  8104 FORMAT (/'  Stresses (Hwang 2011) ',A/                     &
        ' --------------------------------------------------')
  8114 FORMAT ( '       drag coefficient scaling    :',F8.2    /)
 28104 FORMAT ( '  &FLX4 CDFAC =',F6.3,' /')

! W3_FLX5
  8105 FORMAT (/'  Direct use of stress from input'/                          &
        ' --------------------------------------------------'/)

! W3_FLX3
  8113 FORMAT ( '       Max Cd * 10^3               :',F8.2/     &
                '       Cap type                    : ',A/)
 28103 FORMAT (  '  &FLX3 CDMAX =',F6.2,'E-3 , CTYPE = ',I1,' /')

!
! W3_LN0
  8200 FORMAT (/'  Linear input not defined.'/)

! W3_SEED
  8203 FORMAT (/'  Seeding as proxi for linear input.'/)

!
! W3_LN1
  8201 FORMAT (/'  Linear input (C&M-R 82) ',A/                   &
        ' --------------------------------------------------')
  8211 FORMAT ( '       CLIN                        :',f8.2/      &
...
!
! W3_ST0
  9200 FORMAT (/'  Wind input not defined.'/)

!
! W3_ST1
  9201 FORMAT (/'  Wind input (WAM-3) ',A/                        &
        ' --------------------------------------------------')
  9211 FORMAT ( '       Cinp                        :',E10.3/)
 29201 FORMAT ( '  &SIN1 CINP =',F7.3,' /')

!
! W3_ST2
  9202 FORMAT (/'  Wind input (T&C 1996) ',A/                     &
        ' --------------------------------------------------')
  9212 FORMAT ( '       Height of input wind (m)    :',F8.2/      &
...
! W3_ST2
 29202 FORMAT ( '  &SIN2 ZWND =',F5.1,', SWELLF =',F6.3,' /')
...
!
! W3_ST3
  9203 FORMAT (/'  Wind input (WAM 4+) ',A/                            &
        ' --------------------------------------------------')
  9213 FORMAT ( '       minimum Charnock coeff.     :',F10.4/          &
                '       betamax                     :',F9.3/           &
 ...
 29203 FORMAT ( '  &SIN3 ZWND =',F5.1,', ALPHA0 =',F8.5,', Z0MAX =',F8.5,', BETAMAX =', &
                  F8.5,','/                                           &
...
!
! W3_ST4
  9204 FORMAT (/'  Wind input (WAM 4+) ',A/                            &
        ' --------------------------------------------------')
  9214 FORMAT ( '       minimum Charnock coeff.     :',F10.4/          &
                '       betamax                     :',F9.3/           &
                '       power of cos. in wind input :',F9.3/           &
                '       z0max                       :',F9.3/           &
                '       zalp                        :',F9.3/           &
 ...
 29204 FORMAT ( '  &SIN4 ZWND =',F5.1,', ALPHA0 =',F8.5,', Z0MAX =',F8.5,', BETAMAX =', &
                  F8.5,','/                                           &
...
!
! W3_ST6
  9206 FORMAT (/'  Wind input (Donelan et al, 2006) ',A/       &
          ' --------------------------------------------------')
  9216 FORMAT ( '  negative wind input active       :  ',A/    &
                '  attenuation factor               :  ',F6.2/ &
                '  wind speed scaling factor        :  ',F6.2/ &
                '  frequency cut-off factor         :  ',F6.2/)
 29206 FORMAT ( '  &SIN6 SINA0 =', F6.3, ', SINWS =', F6.2, ', SINFC =', F6.2, ' /')

!
! W3_NL0
  9220 FORMAT (/'  Nonlinear interactions not defined.'/)

!
! W3_NL1
  9221 FORMAT (/'  Nonlinear interactions (DIA) ',A/                   &
                ' --------------------------------------------------')
  9231 FORMAT ( '       Lambda                      :',F8.2/      &
                '       Prop. constant              :',E10.3/     &
                '       kd conversion factor        :',F8.2/      &
                '       minimum kd                  :',F8.2/      &
                '       shallow water constants     :',F8.2,2F6.2/)
 29221 FORMAT (  '  &SNL1 LAMBDA =',F7.3,', NLPROP =',E10.3,       &
...
!
! W3_NL2
  9222 FORMAT (/'  Nonlinear interactions (WRT) ',A/              &
                 ' --------------------------------------------------')
  9232 FORMAT ( '       Deep/shallow options        : ',A/        &
                '       Power of h-f tail           : ',F6.1)
 19232 FORMAT ( '       Number of depths used       : ',I4/       &
                '       Depths (m)                  :',5F7.1)
 29232 FORMAT ( '                                    ',5F7.1)
 29222 FORMAT ( '  &SNL2 IQTYPE =',I2,', TAILNL =',F5.1,',',      &
                      ' NDEPTH =',I3,' /')
 39232 FORMAT ( '  &SNL2 DEPTHS =',F9.2,' /')
 49232 FORMAT ( '  &ANL2 DEPTHS =',F9.2,' ,')
 59232 FORMAT ( '                ',F9.2,' ,')
 69232 FORMAT ( '                ',F9.2,' /')
...
! W3_NL3
!
  9223 FORMAT (/'  Nonlinear interactions (GMD) ',A/              &
                ' --------------------------------------------------')
  9233 FORMAT ( '       Powers in scaling functions : ',2F7.2/    &
                '       Nondimension filter depths  : ',2F7.2)
 19233 FORMAT ( '       Number of quad. definitions : ',I4)
 29233 FORMAT ( '             ',2F8.3,F6.1,2E12.4)
 29223 FORMAT ( '  &SNL3 NQDEF =',I3,', MSC =',F6.2,',  NSC =',   &
                     F6.2,',  KDFD =',F6.2,',  KDFS =',F6.2,' /')
 39233 FORMAT ( '  &ANL3 QPARMS = ',2(F5.3,', '),F5.1,', ',E10.4, &
                ', ',E10.4,' /')
 49233 FORMAT ( '  &ANL3 QPARMS = ',2(F5.3,', '),F5.1,', ',E10.4, &
                ', ',E10.4,' ,')
 59233 FORMAT ( '                 ',2(F5.3,', '),F5.1,', ',E10.4, &
                ', ',E10.4,' ,')
 69233 FORMAT ( '                 ',2(F5.3,', '),F5.1,', ',E10.4, &
                ', ',E10.4,' /')
!
! W3_NL4
!
  9224 FORMAT (/'  Nonlinear interactions (TSA) ',A/              &
                ' --------------------------------------------------')
  9234 FORMAT ( '   Source term computation (1=TSA,0=FBI) : ',I2/ &
                '   Alternate loops (1=no,2=yes)          : ',I2/ &
                '   (To speed up computation) ')
 29224 FORMAT ( '  &SNL4 ITSA =',I2,', IALT =',I2 )

!
! W3_NL5
!
  9225 FORMAT(/'  Nonlinear interactions (GKE) ',A/              &
               ' --------------------------------------------------')
  9235 FORMAT ( '   Constant water depth (in meter) : ', F7.1/ &
 ...
 29225 FORMAT ( '  &SNL5 NL5DPT =', F7.1, ', NL5OML =', F5.2, &
...
! W3_ST0
!
  9240 FORMAT (/'  Dissipation not defined.'/)

!
! W3_ST1
!
  9241 FORMAT (/'  Dissipation (WAM-3) ',A/                       &
        ' --------------------------------------------------')
  9251 FORMAT ( '       Cdis                        :',E10.3/     &
               '       Apm                         :',E10.3/)
 29241 FORMAT ( '  &SDS1 CDIS =',E12.4,', APM =',E11.4,' /')
!
! W3_ST2
!
  9242 FORMAT (/'  Dissipation (T&C 1996) ',A/                    &
        ' --------------------------------------------------')
  9252 FORMAT ( '       High-frequency constants    :',F8.2,E11.3,F6.2/ &
               '       Low-frequency constants     :',E11.3,F6.2/&
               '                                    ',E11.3,F6.2/&
               '       Minimum input peak freq. (-):',F10.4/     &
               '       Minimum PHI                 :',F10.4/)
 29242 FORMAT ( '  &SDS2 SDSA0 =',E10.3,', SDSA1 =',E10.3,', SDSA2 =', &
                        E10.3,', '/                              &
...
! W3_ST3
!
  9243 FORMAT (/' Dissipation (WAM Cycle 4+) ',A/                 &
        ' --------------------------------------------------')
  9253 FORMAT ( '       SDSC1                       :',1E11.3/    &
               '       Power of k in mean k        :',F8.2/      &
               '       weights of k and k^2        :',F9.3,F6.3/)  
 29243 FORMAT ( '  &SDS3 SDSC1 =',E12.4,', WNMEANP =',F4.2,       &
...
! W3_ST4
!
  9244 FORMAT (/' Dissipation (Ardhuin / Filipot / Romero ) ',A/          &
        ' --------------------------------------------------')
  9254 FORMAT ( '       SDSC2, SDSBCK, SDSCUM       :',3E11.3/    &
               '       Power of k in mean k        :',F8.2/)      
 29244 FORMAT ( '  &SDS4 SDSBCHOICE = ',F3.1,                       &
...
! W3_ST6
!
  9246 FORMAT (/'  Dissipation (Rogers et al. 2012) ',A/             &
               ' --------------------------------------------------')
  9256 FORMAT ( '  normalise by threshold spectral density    :  ',A/&
...
! W3_BT0
!
  9260 FORMAT (/'  Bottom friction not defined.'/)
!
! W3_BT1
!
  9261 FORMAT (/'  Bottom friction (JONSWAP) ',A/                 &
               ' --------------------------------------------------')
  9271 FORMAT ( '       gamma                       :',F8.4/)
  29261 FORMAT ( '  &SBT1 GAMMA =',E12.4,' /')
!
! W3_BT4
!
  9264 FORMAT (/'  Bottom friction  (SHOWEX)  ',A/                 &
               ' --------------------------------------------------')
  9274 FORMAT ( '       SEDMAPD50, SED_D50_UNIFORM        :',L3,1X,F8.6/ &
               '       RIPFAC1,RIPFAC2,RIPFAC3,RIPFAC4   :',4F8.4/      &
               '       SIGDEPTH, BOTROUGHMIN, BOTROUGHFAC:',3F8.4/)          
 29264 FORMAT ( '  &SBT4 SEDMAPD50 =',L3,', SED_D50_UNIFORM =',F8.6,','/ &
...
! W3_DB0
!
  9280 FORMAT (/'  Surf breaking not defined.'/)
!
! W3_DB1
!
  9281 FORMAT (/'  Surf breaking (B&J 1978) ',A/                  &
               ' --------------------------------------------------')
...
! W3_BS0
!
  9320 FORMAT (/'  Bottom scattering not defined.'/)
!
! W3_BS1
!
  9321 FORMAT (/'  Experimental bottom scattering (F. Ardhuin).'/)
!
! W3_IC1
!
  9351 FORMAT (/'  Dissipation via ice parameters (SIC1).'&
           ,/' --------------------------------------------------')
!
! W3_IC2
!
  9352 FORMAT (/'  Dissipation via ice parameters (SIC2).'&
           ,/' --------------------------------------------------')
!
! W3_IC3
!
  9353 FORMAT (/'  Dissipation via ice parameters (SIC3).'&
           ,/' --------------------------------------------------')
!
! W3_IC4
!
  9354 FORMAT (/'  Dissipation via ice parameters (SIC4).'&
           ,/' --------------------------------------------------')
!
! W3_IC5
!
  9355 FORMAT (/'  Dissipation via ice parameters (SIC5).'&
           ,/' --------------------------------------------------')
!
! W3_IS0
!
...
! W3_PR1
!
  9531 FORMAT ( '       CFLmax depth refraction     :',F9.3/)
 29531 FORMAT ( '  &PRO1 CFLTM =',F5.2,' /')
!
! W3_PR2
!
 9532 FORMAT ( '       CFLmax depth refraction     :',F9.3/      &
               '       Effective swell age     (h) : switched off'/   &
               '       Cut-off latitude    (degr.) :',F7.1/)
 9542 FORMAT ( '       CFLmax depth refraction     :',F9.3/      &
               '       Effective swell age     (h) :',F8.2/      &
               '       Cut-off latitude    (degr.) :',F7.1/)
 29532 FORMAT ( '  &PRO2 CFLTM =',F5.2,', DTIME =',F8.0,          &
                       ', LATMIN =',F5.1,' /')
!
! W3_SMC
!
...
! W3_PR3
!
  9533 FORMAT ( '       CFLmax depth refraction     :',F9.3/      &
                '       Averaging area factor Cg    :',F8.2)
  9543 FORMAT ( '       Averaging area factor theta :',F8.2)
   955 FORMAT ( '            **** Internal maximum .GE.',F6.2,' ****')
 29533 FORMAT ( '  &PRO3 CFLTM =',F5.2,                           &
...
!
! W3_IC2
 9712 FORMAT (/'  Boundary layer below ice  ',A/      &
               ' --------------------------------------------------')

! W3_IC3
 9713 FORMAT (/'  Visco-elastic ice layer   ',A/      &
               ' --------------------------------------------------')

! W3_IC4
 9714 FORMAT (/'  Empirical wave-ice physics   ',A/      &
               ' --------------------------------------------------')

! W3_IC5
 9715 FORMAT (/'  Effective medium ice model (SIC5) ',A/      &
               ' --------------------------------------------------')
...
10042 FORMAT (/' *** WAVEWATCH III ERROR IN READNL : '/          &
         '     TEMP DEPTH ARRAY TOO SMALL, .LE. ',I8/)
10043 FORMAT (/' *** WAVEWATCH-III ERROR IN READNL : '/          &
