...
MODULE W3GRIDMD
  ...
  USE W3ODATMD    , ONLY : IPBPO, ISBPO, XBPO, YBPO, RDBPO, FNMPRE
  USE W3ODATMD    , ONLY : IHMAX, HSPMIN, WSMULT, WSCUT, FLCOMB
  USE W3ODATMD    , ONLY : NOSWLL, PTMETH, PTFCUT
  USE W3TIMEMD    , ONLY : CALTYPE
  USE W3NMLGRIDMD
#ifdef W3_SCRIP
  USE SCRIP_GRIDS , ONLY : GRID1_UNITS, GRID1_NAME
  USE SCRIP_GRIDS , ONLY : GRID1_CENTER_LON, GRID1_CENTER_LAT
  USE SCRIP_GRIDS , ONLY : GRID1_CORNER_LON, GRID1_CORNER_LAT
  USE SCRIP_GRIDS , ONLY : GRID1_MASK, GRID1_SIZE, GRID1_RANK
  USE SCRIP_GRIDS , ONLY : GRID1_IMASK
  USE SCRIP_GRIDS , ONLY : GRID1_CORNERS, GRID1_DIMS
  USE SCRIP_KINDSMOD
  USE WMSCRPMD
#endif
#ifdef W3_SCRIPNC
