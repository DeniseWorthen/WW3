...
CONTAINS
  ...
  SUBROUTINE W3SREF(A, CG, WN, EMEAN, FMEAN, DEPTH, CX1, CY1, REFLC, REFLD,     &
    ...
    USE W3GDATMD    , ONLY : REFPARS, ECOS, ESIN, EC2, MAPTH, MAEPWN, FLAGLL
    USE W3GDATMD    , ONLY : SIG2, DSII, IOBPD, GTYPE, UNGTYPE, MAPFS, CLGTYPE, RLGTYPE
    ...
    REAL ,    INTENT(IN)    :: REFLC(4), TRNX, TRNY, BERG
