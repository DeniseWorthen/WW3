...
CONTAINS
  ...
  SUBROUTINE W3QCK1 (MX, MY, NX, NY, CFLL, Q, CLOSE, INC,         &
    ...
    ! Formats
    !
9000 FORMAT ( ' TEST W3QCK1 : ARRAY DIMENSIONS  :',2I6/            & ! W3_T
         '               USED              :',2I6/                 &
         '               CLOSE, INC        :',L6,I6/               &
         '               NB0, NB1, NB2     :',3I6)
...
9002 FORMAT ( 1X,43I3)
9003 FORMAT ( 1X,21I6)
9005 FORMAT (' TEST W3QCK1 : GLOBAL CLOSURE (1)') ! W3_T
    !
9010 FORMAT (' TEST W3QCK1 : IP, 2x(IX,IY), CFL (b,i,i+1), ',      & ! W3_T1
         ' Q (b,b,i-1,i,i+1,i+2)')
...
9014 FORMAT (10X,I6,4I4,1X,F6.2,'  --- ',F6.2,1X,F7.2,1X,'  --- ', &
         2F6.2,'  --- ')
9015 FORMAT (' TEST W3QCK1 : GLOBAL CLOSURE (2)') ! W3_T
    !
...
9021 FORMAT ('            ',2I6,2(1X,2E11.3))
  ...
  SUBROUTINE W3QCK2 (MX, MY, NX, NY, VELO, DT, DX1, DX2, Q, CLOSE,&
    ...
    ! Formats
    !
9000 FORMAT ( ' TEST W3QCK2 : ARRAY DIMENSIONS  :',2I6/           & ! W3_T
         '               USED              :',2I6/           &
         '               TIME STEP         :',F8.1/          &
         '               CLOSE, INC        :',L6,I6/         &
         '               NB0, NB1, NB2     :',3I6)
...
9003 FORMAT ( 1X,21I6)
!
9005 FORMAT (' TEST W3QCK2 : GLOBAL CLOSURE (1)') ! W3_T
    !
9010 FORMAT (' TEST W3QCK2 : IP, 2x(IX,IY), CFL (b,i,i+1), ',    & ! W3_T1
         ' Q (b,b,i-1,i,i+1,i+2)')
...
9014 FORMAT (10X,I6,4I4,1X,F6.2,'  --- ',F6.2,1X,F7.2,1X,'  --- ',&
         2F6.2,'  --- ')
9015 FORMAT (' TEST W3QCK2 : GLOBAL CLOSURE (2)') ! W3_T
    !
! W3_T2
...
!!!/OMPH/!$OMP END PARALLEL DO
    ...
    ! Formats
    !
9000 FORMAT ( ' TEST W3QCK3 : ARRAY DIMENSIONS  :',2I6/           & ! W3_T
              '               USED              :',2I6/           &
              '               CLOSE, INC        :',L6,I6/         &
              '               NB0, NB1, NB2     :',3I6)
    ! W3_T0
...
9003 FORMAT ( 1X,21I6)
!
9005 FORMAT (' TEST W3QCK3 : GLOBAL CLOSURE (1)') ! W3_T
    !
9010 FORMAT (' TEST W3QCK3 : IP, 2x(IX,IY), CFL (b,i,i+1), ',    & ! W3_T1
             ' Q (b,b,i-1,i,i+1,i+2)')
...
9014 FORMAT (10X,I6,4I4,1X,F6.2,'  --- ',F6.2,1X,F7.2,1X,'  --- ',&
             2F6.2,'  --- ')
9015 FORMAT (' TEST W3QCK3 : GLOBAL CLOSURE (2)') ! W3_T
    !
    ! W3_T2
