...
MODULE W3CANOMD
  ...
  REAL , SAVE , PRIVATE, ALLOCATABLE   :: TT_4M(:,:,:,:),TT_4P(:,:,:,:),TFAKH(:,:)
  REAL , SAVE , PRIVATE, ALLOCATABLE   :: TFAK(:,:)
#ifdef W3_OMPG
...
CONTAINS
  ...
  SUBROUTINE CAL_SEC_ORDER_SPEC(F1,F3,NFRE,NANG,FR,DFIM,TH,DELTH, &
    ...
    REAL               :: OM0,AA1,BB1
    REAL               :: F,EPSMIN,DELFF,SPEC1,SQRTK
...
62  FORMAT(I4,9F16.9)
  ...
  SUBROUTINE SECSPOM(F1,F3,NFRE,NANG,NMAX,NDEPTH,&
    ...
    INTEGER :: MM,L,MR,NMAX,JD,COUNTER
    INTEGER :: IM_P(NFRE,NFRE),IM_M(NFRE,NFRE),IL(NANG,NANG)

    REAL    :: OM0,OM0H,OM1,OM0P,OM0M
    REAL    :: OMSTART,FRAC,XINCR1,XINCR2,XINCR3,XINCR4,FAC1,FAC2
    REAL    :: FAC3,T_4M,T_4P,F2K,F2KP,F2KM,F2K1,F2K2,DELM1,DEPTHA,DEPTHD
    REAL    :: XD,X_MIN
    REAL    :: OMEGA(NFRE), DFDTH(NFRE), OMEGAHF(NFRE+1:NMAX)
    REAL    :: TA(NANG,NFRE,NFRE,NDEPTH),TB(NANG,NFRE,NFRE,NDEPTH)
    REAL    :: TC_QL(NANG,NFRE,NFRE,NDEPTH),TT_4M(NANG,NFRE,NFRE,NDEPTH)
    REAL    :: TT_4P(NANG,NFRE,NFRE,NDEPTH)
  ...
  REAL FUNCTION VPLUS(XI,XJ,XK,THI,THJ,THK)
    ...
    REAL    :: RIJ,RIK,RJK,SQIJK,SQIKJ,SQJKI,ZCONST
    !
    !***  1. DETERMINE NONLINEAR TRANSFER.
    !     --------------------------------
    !
  ...
  REAL FUNCTION U(XI,XJ,XK,XL,THI,THJ,THK,THL)
    ...
    REAL    :: OIK,OJK,OIL,OJL,QI,QJ,QIK,QJK,QIL,QJL,SQIJKL,ZCONST
    !
    !***  1. DETERMINE NONLINEAR TRANSFER.
    !     --------------------------------
    !
  ...
  REAL FUNCTION V2(XI,XJ,XK,XL,THI,THJ,THK,THL)
    ...
    REAL    :: RIJ,RIK,RLI,RJL,RJK,RKL,THIJ,THIK,THLI,THJL,THJK,THKL,OIJ
    REAL    :: OIK,OJL,OJK,OLI,OKL,XNIK,XNJL,XNJK,XNIL,YNIL,YNJK,YNJL,YNIK
    REAL    :: ZNIJ,ZNKL,ZPIJ,ZPKL,THLJ,THIL,THKJ,THKI,THJI,THLK
    !
    !***  1. DETERMINE NONLINEAR TRANSFER.
    !     --------------------------------
    !
  ...
  REAL FUNCTION B3(XI,XJ,XK,XL,THI,THJ,THK,THL)
    ...
    REAL    :: DEPTH,ALPHA,GAM_J,DEPTHA,DEPTHD
    REAL    :: DEL1,XI,XJ,XK,XL,THI,THJ,THK,THL,OI,OJ,OK,OL,RI,RJ,RK,RL
    REAL    :: RIJ,RJI,RIK,RKI,RLJ,RJL,RJK,RKJ,RLI,RIL,RLK,RKL,THIJ,THJI
    REAL    :: THIK,THKI,THLJ,THJL,THJK,THKJ,THLI,THIL,THLK,THKL,ZIJKL
    !
    !***  1. DETERMINE NONLINEAR TRANSFER.
    !     --------------------------------
    !
  ...
  REAL FUNCTION B4(XI,XJ,XK,XL,THI,THJ,THK,THL)
    ...
    REAL    :: DEPTH,ALPHA,GAM_J,DEPTHA,DEPTHD
    REAL    :: DEL1,XI,XJ,XK,XL,THI,THJ,THK,THL,OI,OJ,OK,OL,RI,RJ,RK,RL
    REAL    :: RIJ,RIK,RIL,RJL,RJK,RKL,THIJ,THIK,THIL,THJL,THJK,THLK,THKL
    REAL    :: ZIJKL
    !
    !***  1. DETERMINE NONLINEAR TRANSFER.
    !     --------------------------------
  ...
  REAL FUNCTION B1(XI,XJ,XK,XL,THI,THJ,THK,THL)
    ...
    REAL    :: DEPTH,ALPHA,GAM_J,DEPTHA,DEPTHD
    REAL    :: DEL1,XI,XJ,XK,XL,THI,THJ,THK,THL,OI,OJ,OK,OL,RI,RJ,RK,RL
    REAL    :: RIJ,RJI,RIK,RKI,RJL,RJK,RLI,RIL,RKL,THIJ,THJI
    REAL    :: THIK,THKI,THJL,THJK,THLI,THIL,THKL,ZIJKL
    !
    !
    !***  1. DETERMINE NONLINEAR TRANSFER.
    !     --------------------------------
  ...
  REAL FUNCTION B2(XI,XJ,XK,XL,THI,THJ,THK,THL)
    ...
    REAL    :: DEPTH,ALPHA,GAM_J,DEPTHA,DEPTHD
    REAL    :: DEL1,XI,XJ,XK,XL,THI,THJ,THK,THL,OI,OJ,OK,OL,RI,RJ,RK,RL
    REAL    :: RIJ,RIK,RKI,RJL,RLJ,RJK,RKJ,RLI,RIL,RKL,THIJ
    REAL    :: THIK,THKI,THJL,THLJ,THJK,THKJ,THLI,THIL,THKL,ZIJKL
    !
    !***  1. DETERMINE NONLINEAR TRANSFER.
    !     --------------------------------
    !
