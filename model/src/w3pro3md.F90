...
CONTAINS
  ...
  SUBROUTINE W3MAP3
    ...
    ! 10. Source code :
    !/ ------------------------------------------------------------------- /
    USE W3GDATMD, ONLY: NK, NTH, NSPEC, NX, NY, NSEA, MAPSTA, MAPSF, GTYPE
    USE W3ADATMD, ONLY: NMX0, NMX1, NMX2, NMY0, NMY1, NMY2, NACT
    USE W3ADATMD, ONLY: NCENT, MAPX2, MAPY2, MAPAXY, MAPCXY
    USE W3ADATMD, ONLY: MAPTH2, MAPWN2
    ...
    INTEGER       :: MAPTXY(NY,NX), I, IXY ! W3_T
    ...
    ! Formats
    !
9000 FORMAT (/' TEST W3MAP3 : TEST MAP FOR PROPAGATION'/          & ! W3_T
         '      MAP     : ',A/                               &
         '      CENTRAL : ',I6/                              &
         '      ABOVE   : ',I6/                              &
         '      BELOW   : ',I6/                              &
...
9001 FORMAT (1X,130I1)
    !
9010 FORMAT (' TEST W3MAP3 : COMPOSITE MAPS TH2, WN2 AND BTK') ! W3_T
9011 FORMAT (2X,60I2)
    !/
    !/ End of W3MAP3 ----------------------------------------------------- /
    !/
  ...
  SUBROUTINE W3XYP3 ( ISP, DTG, MAPSTA, MAPFS, VQ, VGX, VGY )
    ...
    USE W3GDATMD, ONLY: ICLOSE, FLCX, FLCY, NK, NTH, DTH, XFR
    USE W3GDATMD, ONLY: ICLOSE_NONE, ICLOSE_SMPL, ICLOSE_TRPL
    USE W3GDATMD, ONLY: ECOS, ESIN, SIG, WDCG, WDTH, PFMOVE
    USE W3GDATMD, ONLY: FLAGLL, DPDX, DPDY, DQDX, DQDY, GSQRT
    !
    USE W3WDATMD, ONLY: TIME
    !
    USE W3ADATMD, ONLY: NMX0, NMX1, NMX2, NMY0, NMY1, NMY2, NACT
    USE W3ADATMD, ONLY: NCENT, MAPX2, MAPY2, MAPAXY, MAPCXY
    USE W3ADATMD, ONLY: MAPTRN, CG, CX, CY, ATRNX, ATRNY, ITIME
    !
    USE W3IDATMD, ONLY: FLCUR
    !
    USE W3ODATMD, ONLY: NDSE, NDST, FLBPI, NBI, TBPI0, TBPIN
    USE W3ODATMD, ONLY: ISBPI, BBPI0, BBPIN, IAPROC, NAPERR
    !
    ...
    INTEGER :: IIXY1(NSEA), IIXY2(NSEA), IIXY3(NSEA), IIXY4(NSEA)
    INTEGER :: TTEST(2),DTTST
    INTEGER :: IENT = 0 ! W3_S
    REAL    :: CG0, CGA, CGN, CGX, CGY, CXC, CYC, CXMIN, CXMAX, CYMIN, CYMAX
    REAL    :: CGC, FGSE = 1.
    REAL    :: FTH, FTHX, FTHY, FCG, FCGX, FCGY
    REAL    :: DTLOC, DTRAD, DXCGN, DYCGN, DXCGS, DYCGS, DXCGC, DYCGC
    REAL    :: RDI1(NSEA), RDI2(NSEA), RDI3(NSEA), RDI4(NSEA)
    ...
    REAL    :: VLCFLX((NX+1)*NY), VLCFLY((NX+1)*NY), AQ(1-NY:NY*(NX+2))
    ...
    ! Formats
    !
9000 FORMAT (' TEST W3XYP3 : YFIRST  :',L2) ! W3_T
9001 FORMAT (' TEST W3XYP3 : ISP, ITH, IK, COS-SIN :',I8,2I4,2F7.3)
    !
9010 FORMAT (' TEST W3XYP3 : INITIALIZE ARRAYS') ! W3_T
9011 FORMAT (' TEST W3XYP3 : PREPARE AVERAGING')
9012 FORMAT ('         ',4I4,2F7.3)
9013 FORMAT ('         ',8X,2I4,2F7.3)
    !
9020 FORMAT (' TEST W3XYP3 : CALCULATING VCFL0X/Y (NSEA=',I6,')') ! W3_T
9021 FORMAT (1X,I6,2I5,E12.4,2f7.3) ! W3_T1
9022 FORMAT (' TEST W3XYP3 : CALCULATING VCFLUX/Y') ! W3_T
    !
9030 FORMAT (' TEST W3XYP3 : FIELD BEFORE BPI. (NSEA=',I6,')') ! W3_T
9031 FORMAT (1X,I6,2I5,E12.4)
    !
9040 FORMAT (' TEST W3XYP3 : FIELD AFTER PROP. (NSEA=',I6,')') ! W3_T
9041 FORMAT (1X,I6,2I5,E12.4)
  ...
  SUBROUTINE W3KTP3 ( ISEA, FACTH, FACK, CTHG0, CG, WN, DW,       &
    ...
    REAL, INTENT(IN)        :: WN(0:NK+1), DW, DDDX, DDDY
    ...
    ! Formats
    !
9000 FORMAT ( ' TEST W3KTP3 : FLCTH-K, FACTH-K, CTMAX  :',        & ! W3_T
          2L2,2E10.3,F7.3)
