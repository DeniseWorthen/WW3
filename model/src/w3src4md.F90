...
!>
  SUBROUTINE W3SPR4 (A, CG, WN, EMEAN, FMEAN, FMEAN1, WNMEAN,     &
    ...
    USE W3GDATMD  , ONLY : SSTXFTFTAIL, SSWELLF, ESIN, ECOS, AAIRCMIN
    USE W3GDATMD  , ONLY : AAIRGB, AALPHA, ZZWND
#ifdef W3_S
    ...
    REAL ,   INTENT(OUT)   :: EMEAN, FMEAN, FMEAN1, WNMEAN, AMAX, CD, Z0, CHARN
    REAL ,   INTENT(OUT)   :: FMEANWS, DLWMEAN
    !/
    !/ ------------------------------------------------------------------- /
    !/ Local parameters
    !/
...
#endif
    USE CONSTANTS , ONLY : DELAB,ABMIN
    USE W3GDATMD  , ONLY : NK, NTH, NSPEC, DDEN, SIG, SIG2, TH
    USE W3GDATMD  , ONLY : ESIN, ECOS, EC2, ZZWND, AALPHA, BBETA, ZZALP
    USE W3GDATMD  , ONLY : TTAUWSHELTER, SSWELLF, DDEN2, DTH, SSINTHP
    USE W3GDATMD  , ONLY : ZZ0RAT, SSINBR
#ifdef W3_S
    USE W3SERVMD  , ONLY : STRACE
#endif
#ifdef W3_T
...
9000 FORMAT (' TEST W3SIN4 : COMMON FACT.: ',3E10.3)
  ...
  SUBROUTINE INSIN4(FLTABS)
    ...
    USE W3GDATMD  , ONLY : SSDSDTH, SSDSCOS, TH, DTH, XFR, ECOS, ESIN
    USE W3GDATMD  , ONLY : SSDSC,  SSDSBRF1, SSDSBCK, SSDSBINT, SSDSPBK
    USE W3GDATMD  , ONLY : SSDSABK, SSDSHCK, IKTAB, DCKI, SATINDICES
    USE W3GDATMD  , ONLY : SATWEIGHTS, CUMULW, NKHS, NKD, NDTAB, QBI
#ifdef W3_S
    USE W3SERVMD  , ONLY : STRACE
#endif
    !/
...
9000 FORMAT ('TABU_HF, L, K, ALPHA, UST, TAUHFT(K,L) :',(2I4,3F8.3))
  ...
  SUBROUTINE TABU_TAUHF2(SIGMAX)
    ...
    USE W3GDATMD  , ONLY : TTAUWSHELTER, ZZ0MAX
    USE W3ODATMD  , ONLY : NDSE
#ifdef W3_T
    USE W3ODATMD  , ONLY : NDST
#endif
...
9000 FORMAT (' TEST TABU_HFT2, K, L, I, UST, ALPHA, LEVTAIL, TAUHFT2(K,L,I) :',(3I4,4F10.5))
  ...
  SUBROUTINE W3SDS4 (A, K, CG, USTAR, USDIR, DEPTH, DAIR, SRHS,    &
    ...
    USE W3GDATMD , ONLY : SSDSC, EC2, ES2, ESC
    USE W3GDATMD , ONLY : SIG, SSDSP, ECOS, ESIN, DTH, AAIRGB
    USE W3GDATMD , ONLY : SSDSISO, SSDSDTH, SSDSBM, AAIRCMIN
    USE W3GDATMD , ONLY : SSDSBRFDF, SSDSBCK, IKTAB, DCKI
    USE W3GDATMD , ONLY : SATINDICES, SATWEIGHTS, CUMULW, NKHS, NKD
    USE W3GDATMD , ONLY : NDTAB, QBI
#ifdef W3_IG1
    ...
    REAL ,              INTENT(IN)  :: A(NSPEC), K(NK), CG(NK), DEPTH, DAIR
    REAL ,              INTENT(IN)  :: USTAR, USDIR, DLWMEAN
