...
CONTAINS
  ...
  SUBROUTINE WMINIT ( IDSI, IDSO, IDSS, IDST, IDSE, IFNAME,       &
    ...
    USE W3GDATMD , ONLY : XGRD, YGRD, DXDP, DXDQ, DYDP, DYDQ
    USE W3GDATMD , ONLY : HQFAC, HPFAC, MAPSTA, MAPST2
    USE W3GDATMD , ONLY : GRIDSHIFT, NSEAL, NK, NTH, XFR, FR1
    ...
    USE WMMDATMD , ONLY : MPI_COMM_BCT, CROOT, FBCAST
#endif
#ifdef W3_MPRF
...
9084 FORMAT ( '               ',I4,17(2X,A3))
  ...
  SUBROUTINE WMINITNML ( IDSI, IDSO, IDSS, IDST, IDSE, IFNAME,       &
    ...
    USE W3IDATMD , ONLY : JFIRST, INFLAGS2
    USE W3ODATMD , ONLY : NOGRP, NGRPP, FLOUT, TONEXT, FLBPI
    USE W3ODATMD , ONLY : FLBPO, NFBPO, NBI, NDS, IAPROC
    USE W3ODATMD , ONLY : NAPFLD, NAPPNT, NAPTRK,  NAPBPT
    USE W3ODATMD , ONLY : NAPPRT, NAPROC, FNMPRE, OUTPTS, NDST, NDSE
