...
CONTAINS
  ...
  SUBROUTINE W3CSPC ( SP1, NFR1, NTH1, XF1, FR1, TH1,             &
    ...
    !/ Local parameters
    !/
    INTEGER                 :: I, NRMAX, J, I1, L1, J1, I2, L2, J2,ISP
    ...
    if (w3_t2_flag) then
       WRITE (NDST,9022)
       DO I=1, NTH1
          WRITE (NDST,9024) I, IDTH(0,I), (IDTH(J,I),RDTH(J,I),J=1,IDTH(0,I))
       END DO
       WRITE (NDST,9023) NFR2T
       DO I=1, NFR1
          WRITE (NDST,9024) I, IDFR(0,I), (IDFR(J,I),RDFR(J,I),J=1,IDFR(0,I))
       END DO
    end if
    !
    ! -------------------------------------------------------------------- /
...
902 FORMAT (/' *** WARNING W3CSPC: NO SPECTRA ***'/)
    !
9000 FORMAT ( ' TEST W3CSPC : NR. OF SPECTRA : ',I8/             & ! W3_T
...
9010 FORMAT ( ' TEST W3CSPC : TEST INFO CASE : ',I8/             &
         ...
         '               OUTPUT SPECTRA : ',2I4,2F8.4,F6.1)
    !
9020 FORMAT ( ' TEST W3CSPC : USING STORED DATA FOR CASE',I4) ! W3_T
...
9024 FORMAT ( '           ',I4,I4,' :',10(I4,F5.2) )
    !
9030 FORMAT ( ' TEST W3CSPC : STARTING CONVERSION') ! W3_T
